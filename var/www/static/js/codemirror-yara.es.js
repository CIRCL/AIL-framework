...
var Ie = /\r\n?|\n/, E = /*@__PURE__*/ (function(e) {
	...
	composeDesc(e) {
		return this.empty ? e : e.empty ? this : He(this, e);
	}
	mapDesc(e, t = !1) {
		return e.empty ? this : Ve(this, e, t);
	}
	...
	compose(e) {
		return this.empty ? e : e.empty ? this : He(this, e, !0);
	}
	map(e, t = !1) {
		return e.empty ? this : Ve(this, e, t, !0);
	}
	iterChanges(e, t = !1) {
		Be(this, e, t);
	}
	...
	filter(t) {
		let n = [], r = [], i = [], a = new Ue(this);
			...
			for (; o < s || o == s && a.len == 0;) {
				...
				D(n, e, t), t > 0 && ze(r, n, a.text), a.forward(e), o += e;
			}
			let c = t[e++];
			for (; o < c;) {
				if (a.done) break done;
	...
	static of(t, n, r) {
		...
		function l(t) {
			if (Array.isArray(t)) for (let e of t) l(e);
				...
				let u = l ? typeof l == "string" ? C.of(l.split(r || Ie)) : l : C.empty, d = u.length;
				if (e == s && d == 0) return;
				e < o && c(), e > o && D(i, e - o, -1), D(i, s - e, d), ze(a, i, u), o = s;
			}
		}
		return l(t), c(!s), s;
	}
...
function Ve(e, t, n, r = !1) {
	let i = [], a = r ? [] : null, o = new Ue(e), s = new Ue(t);
	for (let e = -1;;) if (o.done && s.len || s.done && o.len) throw Error("Mismatched change set lengths");
		...
		for (D(i, s.ins, -1); t;) {
			...
			o.ins >= 0 && e < o.i && o.len <= n && (D(i, 0, o.ins), a && ze(a, i, o.text), e = o.i), o.forward(n), t -= n;
		}
		s.next();
	} else if (o.ins >= 0) {
		let t = 0, n = o.len;
		...
		D(i, t, e < o.i ? o.ins : 0), a && e < o.i && ze(a, i, o.text), e = o.i, o.forward(o.len - n);
	} else if (o.done && s.done) return a ? Re.createSet(i, a) : Le.create(i);
	else throw Error("Mismatched change set lengths");
}
function He(e, t, n = !1) {
	let r = [], i = n ? [] : null, a = new Ue(e), o = new Ue(t);
	for (let e = !1;;) if (a.done && o.done) return i ? Re.createSet(r, i) : Le.create(r);
	else if (a.ins == 0) D(r, a.len, 0, e), a.next();
	else if (o.len == 0 && !o.done) D(r, 0, o.ins, e), i && ze(i, r, o.text), o.next();
		...
		if (a.ins == -1) {
			...
			D(r, t, n, e), i && n && ze(i, r, o.text);
		} else o.ins == -1 ? (D(r, a.off ? 0 : a.len, t, e), i && ze(i, r, a.textBit(t))) : (D(r, a.off ? 0 : a.len, o.off ? 0 : o.ins, e), i && !o.off && ze(i, r, o.text));
...
var Ue = class {
	...
	static fromJSON(t) {
		...
		return new e(t.ranges.map((e) => We.fromJSON(e)), t.main);
	}
	static single(t, n = t) {
	...
	static cursor(e, t = 0, n, r) {
		return We.create(e, e, (t == 0 ? 0 : t < 0 ? 8 : 16) | (n == null ? 7 : Math.min(6, n)), r);
	}
	static range(e, t, n, r, i) {
		let a = r == null ? 7 : Math.min(6, r);
		return !i && e != t && (i = t < e ? 1 : -1), i && (a |= i < 0 ? 8 : 16), t < e ? We.create(t, e, a | 32, n) : We.create(e, t, a, n);
	}
	static undirectionalRange(e, t) {
		return We.create(e, t, 64, void 0);
	}
...
var Ke = 0, k = class e {
	constructor(e, t, n, r, i) {
		this.combine = e, this.compareInput = t, this.compare = n, this.isStatic = r, this.id = Ke++, this.default = e([]), this.extensions = typeof i == "function" ? i(this) : i;
	}
	get reader() {
		return this;
	}
	static define(t = {}) {
		return new e(t.combine || ((e) => e), t.compareInput || ((e, t) => e === t), t.compare || (t.combine ? (e, t) => e === t : qe), !!t.static, t.enables);
	}
	of(e) {
		return new Je([], this, 0, e);
	}
	compute(e, t) {
		if (this.isStatic) throw Error("Can't compute a static facet");
		return new Je(e, this, 1, t);
	}
	computeN(e, t) {
		if (this.isStatic) throw Error("Can't compute a static facet");
		return new Je(e, this, 2, t);
	}
	from(e, t) {
...
var Je = class {
	constructor(e, t, n, r) {
		this.dependencies = e, this.facet = t, this.type = n, this.value = r, this.id = Ke++;
	}
	dynamicSlot(e) {
		var t;
		...
		return {
			...
			update(e, t) {
				if (s && t.docChanged || c && (t.docChanged || t.selection) || Xe(e, l)) {
					let t = n(e);
					if (o ? !Ye(t, e.values[a], r) : !r(t, e.values[a])) return e.values[a] = t, 1;
				}
				return 0;
			},
			reconfigure: (e, t) => {
				...
				if (c != null) {
					let i = ct(t, c);
					if (this.dependencies.every((n) => n instanceof k ? t.facet(n) === e.facet(n) : n instanceof A ? t.field(n, !1) == e.field(n, !1) : !0) || (o ? Ye(s = n(e), i, r) : r(s = n(e), i))) return e.values[a] = i, 0;
				} else s = n(e);
...
var Qe = /*@__PURE__*/ k.define({ static: !0 }), A = class e {
	...
	slot(e) {
		...
		return {
			...
			reconfigure: (e, n) => {
				let r = e.facet(Qe), i = n.facet(Qe), a;
...
var tt = {
	highest: /*@__PURE__*/ et($e.highest),
	high: /*@__PURE__*/ et($e.high),
	default: /*@__PURE__*/ et($e.default),
	low: /*@__PURE__*/ et($e.low),
	lowest: /*@__PURE__*/ et($e.lowest)
}, nt = class {
	constructor(e, t) {
	...
	static resolve(t, n, r) {
		...
		for (let e of ot(t, n, o)) e instanceof A ? i.push(e) : (a[e.facet.id] || (a[e.facet.id] = [])).push(e);
		...
		for (let e in a) {
			...
			if (t.every((e) => e.type == 0)) {
				if (s[n.id] = c.length << 1 | 1, qe(i, t)) c.push(r.facet(n));
				else {
				...
				s[n.id] = l.length << 1, l.push((e) => Ze(e, n, t));
			}
		}
		let d = l.map((e) => e(s));
...
function ot(e, t, n) {
	...
	function a(e, o) {
		...
		if (s != null) {
			if (s <= o) return;
			let t = r[s].indexOf(e);
			t > -1 && r[s].splice(t, 1), e instanceof it && n.delete(e.compartment);
		}
		...
		} else if (e instanceof nt) a(e.inner, e.prec);
		else if (e instanceof A) r[o].push(e), e.provides && a(e.provides, o);
		else if (e instanceof Je) r[o].push(e), e.facet.extensions && a(e.facet.extensions, $e.default);
		else {
			let t = e.extension;
	...
	return a(e, $e.default), r.reduce((e, t) => e.concat(t));
}
function st(e, t) {
	if (t & 1) return 2;
...
var lt = /*@__PURE__*/ k.define(), ut = /*@__PURE__*/ k.define({
	combine: (e) => e.some((e) => e),
	static: !0
}), dt = /*@__PURE__*/ k.define({
	combine: (e) => e.length ? e[0] : void 0,
	static: !0
}), ft = /*@__PURE__*/ k.define(), pt = /*@__PURE__*/ k.define(), mt = /*@__PURE__*/ k.define(), ht = /*@__PURE__*/ k.define({ combine: (e) => e.length ? e[0] : !1 }), gt = class {
	constructor(e, t) {
...
yt.time = /*@__PURE__*/ gt.define(), yt.userEvent = /*@__PURE__*/ gt.define(), yt.addToHistory = /*@__PURE__*/ gt.define(), yt.remote = /*@__PURE__*/ gt.define();
function bt(e, t) {
	let n = [];
	for (let r = 0, i = 0;;) {
		let a, o;
...
function xt(e, t, n) {
	var r;
	let i, a, o;
	return n ? (i = t.changes, a = Re.empty(t.changes.length), o = e.changes.compose(t.changes)) : (i = t.changes.map(e.changes), a = e.changes.mapDesc(t.changes, !0), o = e.changes.compose(i)), {
		changes: o,
		selection: t.selection ? t.selection.map(a) : (r = e.selection) == null ? void 0 : r.map(i),
		effects: j.mapEffects(e.effects, i).concat(j.mapEffects(t.effects, a)),
...
function St(e, t, n) {
	...
	return t.userEvent && (i = i.concat(yt.userEvent.of(t.userEvent))), {
		changes: t.changes instanceof Re ? t.changes : Re.of(t.changes || [], n, e.facet(dt)),
...
function Ct(e, t, n) {
	...
	let i = yt.create(e, r.changes, r.selection, r.effects, r.annotations, r.scrollIntoView);
	return Tt(n ? wt(i) : i);
}
function wt(e) {
	...
	if (n !== !0) {
		let r, i;
		if (n === !1) i = e.changes.invertedDesc, r = Re.empty(t.doc.length);
		else {
			let t = e.changes.filter(n);
			r = t.changes, i = t.filtered.mapDesc(t.changes).invertedDesc;
		}
		e = yt.create(t, r, e.selection && e.selection.map(i), j.mapEffects(e.effects, i), e.annotations, e.scrollIntoView);
	}
	let r = t.facet(pt);
	for (let n = r.length - 1; n >= 0; n--) {
		let i = r[n](e);
		e = i instanceof yt ? i : Array.isArray(i) && i.length == 1 && i[0] instanceof yt ? i[0] : Ct(t, Dt(i), !1);
	}
	return e;
}
function Tt(e) {
	...
	return r == e ? e : yt.create(t, e.changes, e.selection, r.effects, r.annotations, r.scrollIntoView);
}
var Et = [];
function Dt(e) {
...
var N = class e {
	constructor(e, t, n, r, i, a) {
		...
		for (let e = 0; e < this.config.dynamicSlots.length; e++) st(this, e << 1);
	...
	applyTransaction(t) {
		...
		for (let e of t.effects) e.is(rt.reconfigure) ? (n && (i = /* @__PURE__ */ new Map(), n.compartments.forEach((e, t) => i.set(t, e)), n = null), i.set(e.value.compartment, e.value.extension)) : e.is(j.reconfigure) ? (n = null, r = e.value) : e.is(j.appendConfig) && (n = null, r = Dt(r).concat(e.value));
		let a;
		n ? a = t.startState.values.slice() : (n = at.resolve(r, i, this), a = new e(n, this.doc, this.selection, n.dynamicSlots.map(() => null), (e, t) => t.reconfigure(e, this), null).values);
		let o = t.startState.facet(ut) ? t.newSelection : t.newSelection.asSingle();
	...
	changeByRange(e) {
		...
		for (let n = 1; n < t.ranges.length; n++) {
			...
			let l = r.mapDesc(s, !0);
			i.push(o.range.map(l)), r = r.compose(c), a = j.mapEffects(a, c).concat(j.mapEffects(Dt(o.effects), l));
		}
		return {
			changes: r,
	...
	changes(t = []) {
		return t instanceof Re ? t : Re.of(t, this.doc.length, this.facet(e.lineSeparator));
	}
	toText(t) {
		return C.of(t.split(this.facet(e.lineSeparator) || Ie));
	}
	...
	facet(e) {
		...
		return t == null ? e.default : (st(this, t), ct(this, t));
	}
	toJSON(e) {
		let t = {
			doc: this.sliceDoc(),
		...
		if (e) for (let n in e) {
			let r = e[n];
			r instanceof A && this.config.address[r.id] != null && (t[n] = r.spec.toJSON(this.field(e[n]), this));
		}
		return t;
	}
	...
	static create(t = {}) {
		let n = at.resolve(t.extensions || [], /* @__PURE__ */ new Map()), r = t.doc instanceof C ? t.doc : C.of((t.doc || "").split(n.staticFacet(e.lineSeparator) || Ie)), i = t.selection ? t.selection instanceof O ? t.selection : O.single(t.selection.anchor, t.selection.head) : O.single(0);
		return Ge(i, r.length), n.staticFacet(ut) || (i = i.asSingle()), new e(n, r, i, n.dynamicSlots.map(() => null), (e, t) => t.create(e), null);
	}
	get tabSize() {
	...
	languageDataAt(e, t, n = -1) {
		let r = [];
		for (let i of this.facet(lt)) for (let a of i(this, t, n)) Object.prototype.hasOwnProperty.call(a, e) && r.push(a[e]);
		return r;
	}
	charCategorizer(e) {
...
N.allowMultipleSelections = ut, N.tabSize = /*@__PURE__*/ k.define({ combine: (e) => e.length ? e[0] : 4 }), N.lineSeparator = dt, N.readOnly = ht, N.phrases = /*@__PURE__*/ k.define({ compare(e, t) {
	let n = Object.keys(e), r = Object.keys(t);
	return n.length == r.length && n.every((n) => e[n] == t[n]);
} }), N.languageData = lt, N.changeFilter = ft, N.transactionFilter = pt, N.transactionExtender = mt, rt.reconfigure = /*@__PURE__*/ j.define();
function Mt(e, t, n = {}) {
	let r = {};
...
Nt.prototype.startSide = Nt.prototype.endSide = 0, Nt.prototype.point = !1, Nt.prototype.mapMode = E.TrackDel;
function Pt(e, t) {
...
var Lt = class e {
		...
		iter: for (let e = 0; e < this.value.length; e++) {
			...
			if (!((h - m || d.endSide - d.startSide) < 0)) {
				if (l < 0 && (l = m), d.point && (u = Math.max(u, h - m)), (m - r || d.startSide - i) >= 0) o.push(d), s.push(m - l), c.push(h - l), r = h, i = d.endSide;
					...
					if (m == h) {
						for (let e = o.length - 1; e > 0; e--) if ((m - c[e - 1] || d.startSide - o[e - 1].endSide) <= 0) {
							o.splice(e, 0, d), s.splice(e, 0, m), c.splice(e, 0, h);
							continue iter;
						}
					}
					a(m, h, d);
	...
	update(t) {
		...
		let s = new Ht(this, null, -1).goto(0), c = 0, l = [], u = new Bt();
	...
	map(t) {
		...
		for (let e = 0; e < this.chunk.length; e++) {
			...
			if (c === !1) i = Math.max(i, s.maxPoint), n.push(s), r.push(t.mapPos(a));
				...
				let [e, c] = n.length ? [Rt(r) + Rt(n).length, Rt(Rt(n).value).endSide] : [-1, -1], { mapped: l, pos: u } = s.map(a, t, e, c, o);
	...
	iter(e = 0) {
		return Ut.from([this]).goto(e);
	}
	get isEmpty() {
		return this.nextLayer == this;
	}
	static iter(e, t = 0) {
		return Ut.from(e).goto(t);
	}
	static compare(e, t, n, r, i = -1) {
		let a = e.filter((e) => e.maxPoint > 0 || !e.isEmpty && e.maxPoint >= i), o = t.filter((e) => e.maxPoint > 0 || !e.isEmpty && e.maxPoint >= i), s = Vt(a, o, n), c = new Gt(a, s, i), l = new Gt(o, s, i);
		n.iterGaps((e, t, n) => Kt(c, e, l, t, n, r)), n.empty && n.length == 0 && Kt(c, 0, l, 0, 0, r);
	}
	static eq(e, t, n = 0, r) {
		r == null && (r = 1e9 - 1);
		...
		let o = Vt(i, a), s = new Gt(i, o, 0).goto(n), c = new Gt(a, o, 0).goto(n);
		for (;;) {
			if (s.to != c.to || !qt(s.active, c.active) || s.point && (!c.point || !Pt(s.point, c.point))) return !1;
			if (s.to > r) return !0;
			s.next(), c.next();
		}
	}
	...
	static of(e, t = !1) {
		let n = new Bt();
		for (let r of e instanceof Ft ? [e] : t ? zt(e) : e) n.add(r.from, r.to, r.value);
		return n.finish();
	}
	static join(t) {
...
var Ht = class {
	...
	static from(t, n = null, r = -1) {
		let i = [];
		for (let e = 0; e < t.length; e++) for (let a = t[e]; !a.isEmpty; a = a.nextLayer) a.maxPoint >= r && i.push(new Ht(a, n, r, e));
	...
	goto(e, t = -1e9) {
		...
		for (let e = this.heap.length >> 1; e >= 0; e--) Wt(this.heap, e);
	...
	next() {
		if (this.heap.length == 0) this.from = this.to = 1e9, this.value = null, this.rank = -1;
			...
			let e = this.heap[0];
			this.from = e.from, this.to = e.to, this.value = e.value, this.rank = e.rank, e.value && e.next(), Wt(this.heap, 0);
		}
	}
};
function Wt(e, t) {
...
var Gt = class {
	constructor(e, t, n) {
		this.minPoint = n, this.active = [], this.activeTo = [], this.activeRank = [], this.minActive = -1, this.point = null, this.pointFrom = 0, this.pointRank = 0, this.to = -1e9, this.endSide = 0, this.openStart = -1, this.cursor = Ut.from(e, t, n);
	}
	goto(e, t = -1e9) {
	...
	removeActive(e) {
		Jt(this.active, e), Jt(this.activeTo, e), Jt(this.activeRank, e), this.minActive = Xt(this.active, this.activeTo);
	}
	addActive(e) {
		let t = 0, { value: n, to: r, rank: i } = this.cursor;
		for (; t < this.activeRank.length && (i - this.activeRank[t] || r - this.activeTo[t]) > 0;) t++;
		Yt(this.active, t, n), Yt(this.activeTo, t, r), Yt(this.activeRank, t, i), e && Yt(e, t, this.cursor.from), this.minActive = Xt(this.active, this.activeTo);
	}
	next() {
...
function Kt(e, t, n, r, i, a) {
	...
	for (let t = !1;;) {
		...
		if (e.point || n.point ? (e.point && n.point && Pt(e.point, n.point) && qt(e.activeForPoint(e.to), n.activeForPoint(n.to)) || a.comparePoint(s, d, e.point, n.point), t = !1) : (t && a.boundChange(s), d > s && !qt(e.active, n.active) && a.compareRange(s, d, e.active, n.active), l && d < o && (r || e.openEnd(u) != n.openEnd(u)) && (t = !0)), u > o) break;
...
for (var $t = "ͼ", en = typeof Symbol > "u" ? "__ͼ" : Symbol.for($t), tn = typeof Symbol > "u" ? "__styleSet" + Math.floor(Math.random() * 1e8) : Symbol("styleSet"), nn = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : {}, rn = class {
	constructor(e, t) {
		this.rules = [];
		let { finish: n } = t || {};
		function r(e) {
	...
	static newName() {
		let e = nn[en] || 1;
		return nn[en] = e + 1, $t + e.toString(36);
	}
	static mount(e, t, n) {
		let r = e[tn], i = n && n.nonce;
		r ? i && r.setNonce(i) : r = new on(e, i), r.mount(Array.isArray(t) ? t : [t], e);
	}
}, an = /* @__PURE__ */ new Map(), on = class {
	constructor(e, t) {
		let n = e.ownerDocument || e, r = n.defaultView;
		if (!e.head && e.adoptedStyleSheets && r.CSSStyleSheet) {
			let t = an.get(n);
			if (t) return e[tn] = t;
			this.sheet = new r.CSSStyleSheet(), an.set(n, this);
		} else this.styleTag = n.createElement("style"), t && this.styleTag.setAttribute("nonce", t);
		this.modules = [], e[tn] = this;
	}
	mount(e, t) {
	...
	221: "}",
	222: "\""
}, ln = typeof navigator < "u" && /Mac/.test(navigator.platform), un = typeof navigator < "u" && /MSIE \d|Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(navigator.userAgent), F = 0; F < 10; F++) sn[48 + F] = sn[96 + F] = String(F);
for (var F = 1; F <= 24; F++) sn[F + 111] = "F" + F;
for (var F = 65; F <= 90; F++) sn[F] = String.fromCharCode(F + 32), cn[F] = String.fromCharCode(F);
for (var dn in sn) cn.hasOwnProperty(dn) || (cn[dn] = sn[dn]);
function fn(e) {
	var t = !(ln && e.metaKey && e.shiftKey && !e.ctrlKey && !e.altKey || un && e.shiftKey && e.key && e.key.length == 1 || e.key == "Unidentified") && e.key || (e.shiftKey ? cn : sn)[e.keyCode] || e.key || "Unidentified";
...
function pn(e, t) {
	if (typeof t == "string") e.appendChild(document.createTextNode(t));
		...
		else if (Array.isArray(t)) for (var n = 0; n < t.length; n++) pn(e, t[n]);
...
var L = typeof navigator < "u" ? navigator : {
	...
	vendor: "",
	platform: ""
}, bn = typeof document < "u" ? document : { documentElement: { style: {} } }, xn = /*@__PURE__*/ /Edge\/(\d+)/.exec(L.userAgent), Sn = /*@__PURE__*/ /MSIE \d/.test(L.userAgent), Cn = /*@__PURE__*/ /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(L.userAgent), wn = !!(Sn || Cn || xn), Tn = !wn && /*@__PURE__*/ /gecko\/(\d+)/i.test(L.userAgent), En = !wn && /*@__PURE__*/ /Chrome\/(\d+)/.exec(L.userAgent), Dn = "webkitFontSmoothing" in bn.documentElement.style, On = !wn && /*@__PURE__*/ /Apple Computer/.test(L.vendor), kn = On && (/*@__PURE__*/ /Mobile\/\w+/.test(L.userAgent) || L.maxTouchPoints > 2), R = {
	mac: kn || /*@__PURE__*/ /Mac/.test(L.platform),
	windows: /*@__PURE__*/ /Win/.test(L.platform),
	linux: /*@__PURE__*/ /Linux|X11/.test(L.platform),
	ie: wn,
	ie_version: Sn ? bn.documentMode || 6 : Cn ? +Cn[1] : xn ? +xn[1] : 0,
	gecko: Tn,
	gecko_version: Tn ? +(/*@__PURE__*/ /Firefox\/(\d+)/.exec(L.userAgent) || [0, 0])[1] : 0,
	chrome: !!En,
	chrome_version: En ? +En[1] : 0,
	ios: kn,
	android: /*@__PURE__*/ /Android\b/.test(L.userAgent),
	webkit: Dn,
	webkit_version: Dn ? +(/*@__PURE__*/ /\bAppleWebKit\/(\d+)/.exec(L.userAgent) || [0, 0])[1] : 0,
	safari: On,
	safari_version: On ? +(/*@__PURE__*/ /\bVersion\/(\d+(\.\d+)?)/.exec(L.userAgent) || [0, 0])[1] : 0,
	tabSize: bn.documentElement.style.tabSize == null ? "-moz-tab-size" : "tab-size"
};
function An(e, t) {
...
var In = class {
	...
	static widget(e) {
		...
		return t += n && !e.inlineOrder ? t > 0 ? 3e8 : -4e8 : t > 0 ? 1e8 : -1e8, new zn(e, t, t, n, e.widget || null, !1);
	}
	static replace(e) {
		let t = !!e.block, n, r;
		...
		return new zn(e, n, r, t, e.widget || null, !0);
	}
	static line(e) {
		return new Rn(e);
	}
...
var Ln = class e extends B {
	constructor(e) {
		...
		super(t ? -1 : 5e8, n ? 1 : -6e8, null, e), this.tagName = e.tagName || "span", this.attrs = e.class && e.attributes ? An(e.attributes, { class: e.class }) : e.class ? { class: e.class } : e.attributes || jn;
	}
	eq(t) {
		return this == t || t instanceof e && this.tagName == t.tagName && Mn(this.attrs, t.attrs);
	}
	range(e, t = e) {
...
var Rn = class e extends B {
	...
	eq(t) {
		return t instanceof e && this.spec.class == t.spec.class && Mn(this.spec.attributes, t.spec.attributes);
	}
	range(e, t = e) {
...
Rn.prototype.mapMode = E.TrackBefore, Rn.prototype.point = !0;
var zn = class e extends B {
	constructor(e, t, n, r, i, a) {
	...
	eq(t) {
		return t instanceof e && Vn(this.widget, t.widget) && this.block == t.block && this.startSide == t.startSide && this.endSide == t.endSide;
	}
	range(e, t = e) {
...
var Un = class e extends Nt {
	constructor(e, t, n) {
		super(), this.tagName = e, this.attributes = t, this.rank = n;
	}
	eq(t) {
		return t == this || t instanceof e && this.tagName == t.tagName && Mn(this.attributes, t.attributes);
	}
	static create(t) {
...
function Kn(e, t) {
	...
	try {
		return Gn(e, t.anchorNode);
	} catch (e) {
		return !1;
	}
}
function qn(e) {
	return e.nodeType == 3 ? ur(e, 0, e.nodeValue.length).getClientRects() : e.nodeType == 1 ? e.getClientRects() : [];
}
function Jn(e, t, n, r) {
	return n ? Zn(e, t, n, r, -1) || Zn(e, t, n, r, 1) : !1;
}
function Yn(e) {
...
var sr = null;
R.safari && R.safari_version >= 26 && (sr = !1);
function cr(e) {
	if (e.setActive) return e.setActive();
	if (sr) return e.focus(sr);
	let t = ar(e);
	e.focus(sr == null ? { get preventScroll() {
...
function pr(e, t) {
	...
	for (r = Math.min(r, Qn(n));;) if (r) {
		if (n.nodeType != 1) return !1;
		let e = n.childNodes[r - 1];
		e.contentEditable == "false" ? r-- : (n = e, r = Qn(n));
	} else if (n == e) return !0;
	else r = Yn(n), n = n.parentNode;
}
function mr(e) {
...
function hr(e, t) {
	for (let n = e, r = t;;) if (n.nodeType == 3 && r > 0) return {
		...
		n = n.childNodes[r - 1], r = Qn(n);
	} else if (n.parentNode && !Xn(n)) r = Yn(n), n = n.parentNode;
	else return null;
}
function gr(e, t) {
	...
	} else if (n.parentNode && !Xn(n)) r = Yn(n) + 1, n = n.parentNode;
	else return null;
}
var _r = class e {
	constructor(e, t, n = !0) {
	...
	static before(t, n) {
		return new e(t.parentNode, Yn(t), n);
	}
	static after(t, n) {
		return new e(t.parentNode, Yn(t) + 1, n);
	}
}, V = /*@__PURE__*/ (function(e) {
	return e[e.LTR = 0] = "LTR", e[e.RTL = 1] = "RTL", e;
})(V || (V = {})), vr = V.LTR, yr = V.RTL;
function br(e) {
	let t = [];
	for (let n = 0; n < e.length; n++) t.push(1 << e[n]);
	return t;
}
var xr = /*@__PURE__*/ br("88888888888888888888888888888888888666888888787833333333337888888000000000000000000000000008888880000000000000000000000000088888888888888888888888888888888888887866668888088888663380888308888800000000000000000000000800000000000000000000000000000008"), Sr = /*@__PURE__*/ br("4444448826627288999999999992222222222222222222222222222222222222222222222229999999999999999999994444444444644222822222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222999999949999999229989999223333333333"), Cr = /*@__PURE__*/ Object.create(null), wr = [];
for (let e of [
	"()",
	"[]",
	"{}"
...
function Tr(e) {
	return e <= 247 ? xr[e] : 1424 <= e && e <= 1524 ? 2 : 1536 <= e && e <= 1785 ? Sr[e - 1536] : 1774 <= e && e <= 2220 ? 4 : 8192 <= e && e <= 8204 ? 256 : 64336 <= e && e <= 65023 ? 4 : 1;
}
var Er = /[\u0590-\u05f4\u0600-\u06ff\u0700-\u08ac\ufb50-\ufdff]/, Dr = class {
	get dir() {
		return this.level % 2 ? yr : vr;
	}
	constructor(e, t, n) {
...
function Or(e, t) {
	...
	for (let n = 0; n < e.length; n++) {
		let r = e[n], i = t[n];
		if (r.from != i.from || r.to != i.to || r.direction != i.direction || !Or(r.inner, i.inner)) return !1;
	}
	return !0;
}
var H = [];
...
function Ar(e, t, n, r, i) {
	...
	for (let o = 0, s = 0, c = 0; o <= r.length; o++) {
		...
		for (let t = l, n, r, o; t < u; t++) if (r = Cr[n = e.charCodeAt(t)]) {
			if (r < 0) {
				for (let e = s - 3; e >= 0; e -= 3) if (wr[e + 1] == -r) {
					let n = wr[e + 2], r = n & 2 ? i : n & 4 ? n & 1 ? a : i : 0;
					r && (H[t] = H[wr[e]] = r), s = e;
					break;
				}
			} else if (wr.length == 189) break;
			else wr[s++] = t, wr[s++] = n, wr[s++] = c;
		} else if ((o = H[t]) == 2 || o == 1) {
			let e = o == i;
			c = +!e;
...
function Mr(e, t, n, r, i, a, o) {
	...
	if (r % 2 == i % 2) for (let c = t, l = 0; c < n;) {
		...
		run: for (;;) if (l < a.length && p == a[l].from) {
			...
			l++, d ? d.push(m) : (m.from > c && o.push(new Dr(c, m.from, f)), Nr(e, m.direction == vr == !(f % 2) ? r : r + 1, i, m.inner, m.from, m.to, o), c = m.to), p = m.to;
		} else if (p == n || (t ? H[p] != s : H[p] == s)) break;
		else p++;
		d ? Mr(e, c, p, r + 1, i, d, o) : c < p && o.push(new Dr(c, p, f)), c = p;
	}
		...
		run: for (;;) if (l && p == a[l - 1].to) {
			...
			d ? d.push(m) : (m.to < c && o.push(new Dr(m.to, c, f)), Nr(e, m.direction == vr == !(f % 2) ? r : r + 1, i, m.inner, m.from, m.to, o), c = m.from), p = m.from;
		} else if (p == t || (n ? H[p - 1] != s : H[p - 1] == s)) break;
		else p--;
		d ? Mr(e, p, c, r + 1, i, d, o) : p < c && o.push(new Dr(p, c, f)), c = p;
	}
}
function Nr(e, t, n, r, i, a, o) {
	let s = t % 2 ? 2 : 1;
	kr(e, i, a, r, s), Ar(e, i, a, r, s), jr(i, a, r, s), Mr(e, i, a, t, n, r, o);
}
function Pr(e, t, n) {
	if (!e) return [new Dr(0, 0, +(t == yr))];
	if (t == vr && !n.length && !Er.test(e)) return Fr(e.length);
	if (n.length) for (; e.length > H.length;) H[H.length] = 256;
	let r = [], i = t == vr ? 0 : 1;
	return Nr(e, i, i, n, 0, e.length, r), r;
}
function Fr(e) {
	return [new Dr(0, e, 0)];
}
...
function Lr(e, t, n, r, i) {
	var a;
	let o = r.head - e.from, s = Dr.find(t, o, (a = r.bidiLevel) == null ? -1 : a, r.assoc), c = t[s], l = c.side(i, n);
	if (o == l) {
		let e = s += i ? 1 : -1;
	...
	(u < c.from || u > c.to) && (u = l), Ir = e.text.slice(Math.min(o, u), Math.max(o, u));
	let d = s == (i ? t.length - 1 : 0) ? null : t[s + (i ? 1 : -1)];
	return d && u == l && d.level + +!i < c.level ? O.cursor(d.side(!i, n) + e.from, d.forward(i, n) ? 1 : -1, d.level) : O.cursor(u + e.from, c.forward(i, n) ? -1 : 1, c.level);
}
function Rr(e, t, n) {
	for (let r = t; r < n; r++) {
		let t = Tr(e.charCodeAt(r));
		if (t == 1) return vr;
		if (t == 2 || t == 4) return yr;
	}
	return vr;
}
var zr = /*@__PURE__*/ k.define(), Br = /*@__PURE__*/ k.define(), Vr = /*@__PURE__*/ k.define(), Hr = /*@__PURE__*/ k.define(), Ur = /*@__PURE__*/ k.define(), Wr = /*@__PURE__*/ k.define(), Gr = /*@__PURE__*/ k.define(), Kr = /*@__PURE__*/ k.define(), qr = /*@__PURE__*/ k.define(), Jr = /*@__PURE__*/ k.define({ combine: (e) => e.some((e) => e) }), Yr = /*@__PURE__*/ k.define({ combine: (e) => e.some((e) => e) }), Xr = /*@__PURE__*/ k.define(), Zr = class e {
...
}, Qr = /*@__PURE__*/ j.define({ map: (e, t) => e.map(t) }), $r = /*@__PURE__*/ j.define();
function U(e, t, n) {
	let r = e.facet(Hr);
	r.length ? r[0](t) : window.onerror && window.onerror(String(t), n, void 0, void 0, t) || (n ? console.error(n + ":", t) : console.error(t));
}
var ei = /*@__PURE__*/ k.define({ combine: (e) => !e.length || e[0] }), ti = 0, ni = /*@__PURE__*/ k.define({ combine(e) {
	return e.filter((t, n) => {
	...
	constructor(e, t, n, r, i) {
		this.id = e, this.create = t, this.domEventHandlers = n, this.domEventObservers = r, this.baseExtensions = i(this), this.extension = this.baseExtensions.concat(ni.of({
			plugin: this,
			arg: void 0
		}));
	}
	of(e) {
		return this.baseExtensions.concat(ni.of({
			plugin: this,
			arg: e
		}));
	}
	static define(t, n) {
		...
		return new e(ti++, t, r, i, (e) => {
			let t = [];
			return o && t.push(oi.of((t) => {
				let n = t.plugin(e);
				return n ? o(n) : B.none;
			})), a && t.push(a(e)), t;
		});
...
}, ii = /*@__PURE__*/ k.define(), ai = /*@__PURE__*/ k.define(), oi = /*@__PURE__*/ k.define(), si = /*@__PURE__*/ k.define(), ci = /*@__PURE__*/ k.define(), li = /*@__PURE__*/ k.define(), ui = /*@__PURE__*/ k.define();
function di(e, t) {
	let n = e.state.facet(ui);
	...
	return P.spans(r, t.from, t.to, {
		...
		span(e, n, r, a) {
			...
			for (let e = r.length - 1; e >= 0; e--, a--) {
				...
				if (n == null && (n = Rr(t.text, o, s)), a > 0 && c.length && (i = c[c.length - 1]).to == o && i.direction == n) i.to = s, c = i.inner;
				else {
					let e = {
						from: o,
						to: s,
...
var fi = /*@__PURE__*/ k.define();
function pi(e) {
	let t = 0, n = 0, r = 0, i = 0;
	for (let a of e.state.facet(fi)) {
		let o = a(e);
...
var mi = /*@__PURE__*/ k.define(), hi = class e {
	constructor(e, t, n, r) {
	...
	constructor(e, t, n) {
		this.view = e, this.state = t, this.transactions = n, this.flags = 0, this.startState = e.state, this.changes = Re.empty(this.startState.doc.length);
		for (let e of n) this.changes = this.changes.compose(e.changes);
		let r = [];
		this.changes.iterChangedRanges((e, t, n, i) => r.push(new hi(e, t, n, i))), this.changedRanges = r;
	}
	static create(t, n, r) {
		return new e(t, n, r);
	}
	...
	domPosFor(e, t) {
		let n = Yn(this.dom), r = this.length ? e > 0 : t > 0;
		return new _r(this.parent.dom, n + +!!r, e == 0 || e == this.length);
	}
	markDirty(e) {
	...
	get root() {
		for (let e = this; e; e = e.parent) if (e instanceof bi) return e;
		return null;
	}
	static get(e) {
		return e.cmTile;
	...
	sync(e) {
		...
		for (let o of this.children) {
			if (o.sync(e), a += o.length + o.breakAfter, r = n ? n.nextSibling : t.firstChild, i && r != o.dom && (i.written = !0), o.dom.parentNode == t) for (; r && r != o.dom;) r = yi(r);
			else t.insertBefore(o.dom, r);
			n = o.dom;
		}
		for (r = n ? n.nextSibling : t.firstChild, i && r && (i.written = !0); r;) r = yi(r);
		this.length = a;
	}
};
function yi(e) {
...
var bi = class extends vi {
	...
	blockTiles(e) {
		for (let t = [], n = this, r = 0, i = 0;;) if (r == n.children.length) {
			...
			let a = n.children[r++];
			if (a instanceof xi) t.push(r), n = a, r = 0;
			else {
	...
	resolveInline(e, t, n) {
		...
		function s(e, c) {
			for (let l = 0, u = 0; l < e.children.length && u <= c; l++) {
				...
				f >= c && (d.isComposite() ? s(d, c - u) : (!a || a.isHidden && (t > 0 && !(a.flags & 32) || n && wi(a, d))) && (f > c || d.flags & 32 && t <= 1) ? (a = d, o = c - u) : (u < c || d.flags & 16 && !d.isHidden && t >= -1) && (r = d, i = c - u)), u = f;
			}
		}
		s(this, e);
		let c = (t < 0 ? r : a) || r || a;
	...
	domIn(e, t) {
		...
		if (n) {
			...
			if (this.dom.contains(e.dom)) return e.isText() ? new _r(e.dom, Math.min(e.dom.nodeValue.length, r)) : e.domPosFor(r, e.flags & 16 ? 1 : e.flags & 32 ? -1 : t);
			let i = n.tile.parent, a = !1;
			for (let e of i.children) {
				if (a) return new _r(e.dom, 0);
				e == n.tile && (a = !0);
			}
		}
		return new _r(this.dom, 0);
	}
};
function Ci(e) {
...
var Ti = class e extends vi {
	...
	coordsIn(e, t, n) {
		...
		let s = ur(this.dom, i, a).getClientRects();
		if (!s.length) return null;
		let c = s[(o ? o < 0 : t >= 0) ? 0 : s.length - 1];
		return R.safari && !o && c.width == 0 && (c = Array.prototype.find.call(s, (e) => e.width) || c), n == null ? c : $n(c, (o ? o > 0 : t < 0) == n);
	}
	static of(t, n) {
	...
	coordsInWidget(e, t, n) {
		...
		if (r) return r;
		if (n) return $n(this.dom.getBoundingClientRect(), this.length ? e == 0 : t <= 0);
		{
	...
	addText(e, t, n, r) {
		...
		if (o && o.isText() && !(o.flags & 8) && o.length + e.length < 512) {
			...
			let t = a.children[a.children.length - 1] = new Ei(o.dom, o.text + e);
			t.parent = a;
		} else a.append(r || Ei.of(e, (i = this.cache.find(Ei)) == null ? void 0 : i.dom));
	...
	addComposition(e, t) {
		...
		for (let e = t.marks.length - 1; e >= 0; e--) {
			...
			if (i instanceof Ti && i.mark.eq(n.mark)) i.dom != n.dom && i.setDOM(Vi(n.dom)), r = i;
			else {
				if (this.cache.reused.get(n)) {
					let e = G.get(n.dom);
					e && e.setDOM(Vi(n.dom));
				}
				let e = Ti.of(n.mark, n.dom);
				r.append(e), r = e;
			}
		...
		let a = new Ei(e.text, e.text.nodeValue);
	...
	addLineStart(e, t) {
		var n;
		e || (e = Ri);
		let r = Si.start(e, t || ((n = this.cache.find(Si)) == null ? void 0 : n.dom), !!t);
	...
	ensureMarks(e, t) {
		...
		for (let i = e.length - 1; i >= 0; i--) {
			let a = e[i], o;
			if (t > 0 && (o = r.lastChild) && o instanceof Ti && o.mark.eq(a)) r = o, t--;
			else {
				let e = Ti.of(a, (n = this.cache.find(Ti, (e) => e.mark.eq(a))) == null ? void 0 : n.dom);
				r.append(e), r = e, t = 0;
			}
		}
		return r;
	...
	endLine() {
		if (this.curLine) {
			...
			(!e || !Ii(this.curLine, !1) || e.dom.nodeName != "BR" && e.isWidget() && !(R.ios && Ii(this.curLine, !0))) && this.curLine.append(this.cache.findWidget(Ui, 0, 32) || new Di(Ui.toDOM(), 0, Ui, 32)), this.curLine = this.afterWidget = null;
		}
	}
	updateBlockWrappers() {
		...
		for (let e = this.blockWrappers; e.value && e.from <= this.pos; e.next()) if (e.to >= this.pos) {
			let t = e.rank * 102 + e.value.rank, n = new Ai(e.from, e.to, e.value, t), r = this.wrappers.length;
	...
	getBlockPos() {
		...
		for (let n of this.wrappers) {
			let r = t.lastChild;
			if (n.from < this.pos && r instanceof xi && r.wrapper.eq(n.wrapper)) t = r;
			else {
				let r = xi.of(n.wrapper, (e = this.cache.find(xi, (e) => e.wrapper.eq(n.wrapper))) == null ? void 0 : e.dom);
				t.append(r), t = r;
			}
		}
		return t;
	...
	getBuffer(e) {
		let t = 2 | (e < 0 ? 16 : 32), n = this.cache.find(Oi, void 0, 1);
		return n && (n.flags = t), n || new Oi(t);
	}
	flushBuffer() {
...
for (let e = 0; e < Ni.length; e++) Ni[e].bucket = e;
var Pi = class {
	constructor(e) {
		this.view = e, this.buckets = Ni.map(() => []), this.index = Ni.map(() => 0), this.reused = /* @__PURE__ */ new Map();
	}
	add(e) {
	...
	constructor(e, t, n, r, i) {
		this.view = e, this.decorations = r, this.disallowBlockEffectsFor = i, this.openWidget = !1, this.openMarks = 0, this.cache = new Pi(e), this.text = new Mi(e.state.doc), this.builder = new ji(this.cache, new bi(e, e.contentDOM), P.iter(n)), this.cache.reused.set(t, 2), this.old = new ki(t), this.reuseWalker = {
			skip: (e, t, n) => {
	...
	preserve(e, t, n) {
		...
		this.old.advance(e, n ? 1 : -1, {
			skip: (e, t, n) => {
				...
				else if (e instanceof Oi) this.cache.add(e);
				else if (e instanceof Ti) this.builder.ensureLine(null), this.builder.addMark(e, r, i), this.cache.reused.set(e, 1), i = r.length;
				else return !1;
				this.openWidget = !1;
			},
			enter: (e) => {
				e.isLine() ? this.builder.addLineStart(e.attrs, this.cache.maybeReuse(e)) : (this.cache.add(e), e instanceof Ti && r.unshift(e.mark)), this.openWidget = !1;
			},
			leave: (e) => {
				e.isLine() ? r.length && (r.length = i = 0) : e instanceof Ti && (r.shift(), i = Math.min(i, r.length));
			},
			break: () => {
			...
			point: (e, t, a, o, s, c) => {
				if (a instanceof zn) {
					...
					if (i = o.length, s > o.length) r.continueWidget(t - e);
						...
						let i = a.widget || (a.block ? Hi.block : Hi.inline), c = Li(a), l = this.cache.findWidget(i, t - e, c) || Di.of(i, this.view, t - e, c);
	...
	getCompositionContext(e) {
		...
		for (let r = e.parentNode;; r = r.parentNode) {
			...
			e instanceof Ti ? t.push(e) : e != null && e.isLine() ? n = e : e instanceof xi || (r.nodeName == "DIV" && !n && r != this.view.contentDOM ? n = new Si(r, Ri) : n || t.push(Ti.of(new Ln({
...
Hi.inline = /*@__PURE__*/ new Hi("span"), Hi.block = /*@__PURE__*/ new Hi("div");
var Ui = /*@__PURE__*/ new class extends In {
	toDOM() {
	...
	update(e) {
		...
		let r = -1;
		this.view.inputState.composing >= 0 && !this.view.observer.editContext && ((t = this.domChanged) != null && t.newSel ? r = this.domChanged.newSel.head : !ta(e.changes, this.hasComposition) && !e.selectionSet && (r = e.state.selection.main.head));
		let i = r > -1 ? Ji(this.view, e.changes, r) : null;
		if (this.domChanged = null, this.hasComposition) {
			let { from: t, to: r } = this.hasComposition;
			n = new hi(t, r, e.changes.mapPos(t, -1), e.changes.mapPos(r, 1)).addToSet(n.slice());
		}
		...
		this.updateDeco();
		let s = Zi(a, this.decorations, e.changes);
		s.length && (n = hi.extendWithRanges(n, s));
		let c = $i(o, this.blockWrappers, e.changes);
		return c.length && (n = hi.extendWithRanges(n, c)), i && !n.some((e) => e.fromA <= i.range.fromA && e.toA >= i.range.toA) && (n = i.range.addToSet(n.slice())), this.tile.flags & 2 && n.length == 0 ? !1 : (this.updateInner(n, i), e.transactions.length && (this.lastUpdate = Date.now()), !0);
	}
	updateInner(e, t) {
		...
		n.ignore(() => {
			if (t || e.length) {
				...
				t && G.get(t.text) && r.cache.reused.set(G.get(t.text), 2), this.tile = r.run(e, t), Gi(n, r.cache.reused);
			}
		...
		let r = [];
		if (this.view.viewport.from || this.view.viewport.to < this.view.state.doc.length) for (let e of this.tile.children) e.isWidget() && e.widget instanceof na && r.push(e.dom);
		n.updateGaps(r);
	}
	updateEditContextFormatting(e) {
		this.editContextFormatting = this.editContextFormatting.map(e.changes);
		for (let t of e.transactions) for (let e of t.effects) e.is($r) && (this.editContextFormatting = e.value);
	}
	updateSelection(e = !1, t = !1) {
		(e || !this.view.observer.selectionRange.focusNode) && this.view.observer.readSelectionRange();
		let { dom: n } = this.tile, r = this.view.root.activeElement, i = r == n, a = !i && !(this.view.state.facet(ei) || n.tabIndex > -1) && Kn(n, this.view.observer.selectionRange) && !(r && n.contains(r));
		if (!(i || t || a)) return;
		let o = this.forceSelection;
		this.forceSelection = !1;
		let s = this.view.state.selection.main, c, l;
		if (s.empty ? l = c = this.inlineDOMNearPos(s.anchor, s.assoc || 1) : (l = this.inlineDOMNearPos(s.head, s.head == s.from ? 1 : -1), c = this.inlineDOMNearPos(s.anchor, s.anchor == s.from ? 1 : -1)), R.gecko && s.empty && !this.hasComposition && Ki(c)) {
			let e = document.createTextNode("");
			this.view.observer.ignore(() => c.node.insertBefore(e, c.node.childNodes[c.offset] || null)), c = l = new _r(e, 0), o = !0;
		}
		...
		(o || !u.focusNode || (!Jn(c.node, c.offset, u.anchorNode, u.anchorOffset) || !Jn(l.node, l.offset, u.focusNode, u.focusOffset)) && !this.suppressWidgetCursorChange(u, s)) && (this.view.observer.ignore(() => {
			R.android && R.chrome && n.contains(u.focusNode) && ea(u.focusNode, n) && (n.blur(), n.focus({ preventScroll: !0 }));
			let e = Wn(this.view.root);
			if (e) {
				if (s.empty) {
					if (R.gecko) {
						let e = Yi(c.node, c.offset);
						if (e && e != 3) {
							let t = (e == 1 ? hr : gr)(c.node, c.offset);
							t && (c = new _r(t.node, t.offset));
						}
					}
		...
		}), this.view.observer.setSelectionRange(c, l)), this.impreciseAnchor = c.precise ? null : new _r(u.anchorNode, u.anchorOffset), this.impreciseHead = l.precise ? null : new _r(u.focusNode, u.focusOffset);
	}
	...
	coordsAt(e, t, n) {
		...
		return r.isWidget() ? r.widget instanceof na ? null : r.coordsInWidget(i, t, !0) : r.coordsIn(i, t, n);
	}
	lineAt(e, t) {
	...
	coordsForChar(e) {
		...
		function r(e, t) {
			if (e.isComposite()) for (let n of e.children) {
				...
				let n = w(e.text, t);
				if (n == t) return null;
				let r = ur(e.dom, t, n).getClientRects();
	...
	measureVisibleLineHeights(e) {
		let t = [], { from: n, to: r } = e, i = this.view.contentDOM.clientWidth, a = i > Math.max(this.view.scrollDOM.clientWidth, this.minWidth) + 1, o = -1, s = this.view.textDirection == V.LTR, c = 0, l = (e, u, d) => {
			for (let f = 0; f < e.children.length && !(u > r); f++) {
				...
				if (d && !f && (c += m.top - d.top), r instanceof xi) p > n && l(r, u, m);
				else if (u >= n && (c > 0 && t.push(-c), t.push(h + c), c = 0, a)) {
					let e = r.dom.lastChild, t = e ? qn(e) : [];
					if (t.length) {
	...
	updateDeco() {
		let e = 1, t = this.view.state.facet(oi).map((t) => (this.dynamicDecorationMap[e++] = typeof t == "function") ? t(this.view) : t), n = !1, r = this.view.state.facet(ci).map((e, t) => {
		...
		this.blockWrappers = this.view.state.facet(si).map((e) => typeof e == "function" ? e(this.view) : e);
	}
	scrollIntoView(e) {
		if (e.isSnapshot) {
		...
		for (let t of this.view.state.facet(Xr)) try {
...
function Gi(e, t) {
	...
	if (n != 1) {
		n == null && e.destroy();
		for (let n of e.children) Gi(n, t);
	}
}
function Ki(e) {
...
function qi(e, t) {
	...
	let r = hr(n.focusNode, n.focusOffset), i = gr(n.focusNode, n.focusOffset), a = r || i;
...
function Ji(e, t, n) {
	...
	return {
		range: new hi(c.mapPos(a), c.mapPos(o), a, o),
		text: i
	};
}
function Yi(e, t) {
...
function ia(e, t, n, r, i) {
	...
	return n.from + Qt(o, a, e.state.tabSize);
}
function aa(e, t, n) {
...
function oa(e, t, n, r) {
	let i = aa(e, t.head, t.assoc || -1), a = !r || i.type != z.Text || !(e.lineWrapping || i.widgetLineBreaks) ? null : e.coordsAtPos(t.assoc < 0 && t.head > i.from ? t.head - 1 : t.head);
	if (a) {
...
function da(e, t) {
	...
	for (let r = 0; r < t.ranges.length; r++) {
		...
		if (i.empty) {
			...
			let t = ua(e, i.from, -1), n = ua(e, i.to, 1);
...
function fa(e, t, n) {
	let r = ua(e.state.facet(li).map((t) => t(e)), n.from, t.head > n.from ? -1 : 1);
...
function ma(e, t, n, r) {
	...
	for (;;) {
		if (c < 0) return new pa(0, 1);
		if (c > e.viewState.docHeight) return new pa(e.state.doc.length, -1);
	...
	if (e.viewport.from >= l.to || e.viewport.to <= l.from) {
		...
		if (l.type == z.Text) {
			let t = ia(e, i, l, o, s);
			return new pa(t, t == l.from ? 1 : -1);
		}
	}
	if (l.type != z.Text) return c < (l.top + l.bottom) / 2 ? new pa(l.from, 1) : new pa(l.to, -1);
	let u = e.docView.lineAt(l.from, 2);
	return (!u || u.length != l.length) && (u = e.docView.lineAt(l.from, -2)), new ha(e, o, s, e.textDirectionAt(l.from)).scanTile(u, l.from);
}
var ha = class {
	constructor(e, t, n, r) {
	...
	scanText(e, t) {
		...
		let r = this.scan(n, (r) => {
			...
			return ur(e.dom, i, a).getClientRects();
		});
		return r.after ? new pa(n[r.i + 1], -1) : new pa(n[r.i], 1);
	}
	scanTile(e, t) {
		if (!e.length) return new pa(t, 1);
		...
		let r = this.scan(n, (t) => {
			let n = e.children[t];
			return n.flags & 48 ? null : (n.dom.nodeType == 1 ? n.dom : ur(n.dom, 0, n.length)).getClientRects();
		}), i = e.children[r.i], a = n[r.i];
		return i.isText() ? this.scanText(i, a) : i.isComposite() ? this.scanTile(i, a) : r.after ? new pa(n[r.i + 1], -1) : new pa(a, 1);
	}
}, ga = "￿", _a = class {
	constructor(e, t) {
	...
	readRange(e, t) {
		...
		for (let r = e;;) {
			...
			let o = G.get(a);
			(i && o ? i.breakAfter : (i ? i.breakAfter : Xn(r)) || Xn(a) && (r.nodeName != "BR" || i != null && i.isWidget()) && this.text.length > e) && !ya(a, t) && this.lineBreak(), r = a;
		}
	...
	findPointInside(e, t) {
		for (let n of this.points) (e.nodeType == 3 ? n.node == e : e.contains(n.node)) && (n.pos = this.text.length + (va(e, n.node, n.offset) ? t : 0));
	}
};
function va(e, t, n) {
	for (;;) {
		if (!t || n < Qn(t)) return !1;
		if (t == e) return !0;
		n = Yn(t) + 1, t = t.parentNode;
	}
}
function ya(e, t) {
	let n;
...
var ba = class {
	...
	constructor(e, t, n, r) {
		...
		if (e.state.readOnly && t > -1) this.newSel = null;
			...
			let t = i || a ? [] : Da(e), n = new _a(t, e);
			n.readRange(this.bounds.startDOM, this.bounds.endDOM), this.text = n.text, this.newSel = Oa(t, this.bounds.from);
		} else {
			let t = e.observer.selectionRange, n = i && i.node == t.focusNode && i.offset == t.focusOffset || !Gn(e.contentDOM, t.focusNode) ? o.main.head : e.docView.posFromDOM(t.focusNode, t.focusOffset), r = a && a.node == t.anchorNode && a.offset == t.anchorOffset || !Gn(e.contentDOM, t.anchorNode) ? o.main.anchor : e.docView.posFromDOM(t.anchorNode, t.anchorOffset), s = e.viewport;
...
function Ca(e, t) {
	...
	if (t.bounds) {
		...
		let l = i.doc.sliceString(e, r, ga), u, d;
		!a.empty && a.from >= e && a.to <= r && (t.typeOver || l != t.text) && l.slice(0, a.from - e) == t.text.slice(0, a.from - e) && l.slice(a.to - e) == t.text.slice(u = t.text.length - (l.length - (a.to - e))) ? n = {
			from: a.from,
			to: a.to,
			insert: C.of(t.text.slice(a.from - e, u).split(ga))
		} : (d = Ea(l, t.text, s - e, c)) && (R.chrome && o == 13 && d.toB == d.from + 2 && t.text.slice(d.from, d.toB) == "￿￿" && d.toB--, n = {
			from: e + d.from,
			to: e + d.toA,
			insert: C.of(t.text.slice(d.from, d.toB).split(ga))
		});
	} else r && (!e.hasFocus && i.facet(ei) || ka(r, a)) && (r = null);
	if (!n && !r) return !1;
	if ((R.mac || R.android) && n && n.from == n.to && n.from == a.head - 1 && /^\. ?$/.test(n.insert.toString()) && e.contentDOM.getAttribute("autocorrect") == "off" ? (r && n.insert.length == 2 && (r = O.single(r.main.anchor - 1, r.main.head - 1)), n = {
		from: n.from,
		to: n.to,
	...
	} : R.chrome && n && n.from == n.to && n.from == a.head && n.insert.toString() == "\n " && e.lineWrapping && (r && (r = O.single(r.main.anchor - 1, r.main.head - 1)), n = {
		from: a.from,
		to: a.to,
		insert: C.of([" "])
	}), n) return wa(e, n, r, o);
	if (r && !ka(r, a)) {
		let t = !1, n = "select";
		return e.inputState.lastSelectionTime > Date.now() - 50 && (e.inputState.lastSelectionOrigin == "select" && (t = !0), n = e.inputState.lastSelectionOrigin, n == "select.pointer" && (r = da(i.facet(li).map((t) => t(e)), r))), e.dispatch({
			selection: r,
			scrollIntoView: t,
			userEvent: n
		}), !0;
...
function wa(e, t, n, r = -1) {
	...
	if (R.android && (t.to == i.to && (t.from == i.from || t.from == i.from - 1 && e.state.sliceDoc(t.from, i.from) == " ") && t.insert.length == 1 && t.insert.lines == 2 && dr(e.contentDOM, "Enter", 13) || (t.from == i.from - 1 && t.to == i.to && t.insert.length == 0 || r == 8 && t.insert.length < t.to - t.from && t.to > i.head) && dr(e.contentDOM, "Backspace", 8) || t.from == i.from && t.to == i.to + 1 && t.insert.length == 0 && dr(e.contentDOM, "Delete", 46))) return !0;
	let a = t.insert.toString();
	e.inputState.composing >= 0 && e.inputState.composing++;
	let o, s = () => o || (o = Ta(e, t, n));
...
function Ta(e, t, n) {
	...
	if (t.from == t.to && t.from < a.from || t.from > a.to) {
		let n = t.from < a.from ? -1 : 1, r = n < 0 ? a.from : a.to, s = ua(i.facet(li).map((t) => t(e)), r, n);
		t.from == s && (o = s);
	}
	if (o > -1) r = {
		changes: t,
		...
		if (i.selection.ranges.length > 1 && (e.inputState.composing >= 0 || e.inputState.compositionPendingChange) && t.to <= a.to + 10 && t.to >= a.to - 10) {
			let c = e.state.sliceDoc(t.from, t.to), l, u = n && qi(e, n.main.head);
			if (u) {
...
function Da(e) {
	...
	return n && (t.push(new ba(n, r)), (i != n || a != r) && t.push(new ba(i, a))), t;
}
function Oa(e, t) {
...
var Aa = class {
	...
	ensureHandlers(e) {
		let t = Na(e), n = this.handlers, r = this.view.contentDOM;
	...
	keydown(e) {
		...
		if (this.tabFocusMode > 0 && e.keyCode != 27 && Ia.indexOf(e.keyCode) < 0 && (this.tabFocusMode = -1), R.android && R.chrome && !e.synthetic && (e.keyCode == 13 || e.keyCode == 8)) return this.view.observer.delayAndroidKey(e.key, e.keyCode), !0;
		if (R.ios && !e.synthetic && !e.altKey && !e.metaKey && (Pa.some((t) => t.keyCode == e.keyCode) && !e.ctrlKey || Fa.indexOf(e.key) > -1 && e.ctrlKey)) {
			let t = {
				ctrlKey: e.ctrlKey,
				altKey: e.altKey,
				metaKey: e.metaKey,
			...
			return t.shiftKey && R.ios && !/^(off|none)$/.test(this.view.contentDOM.autocapitalize) && ja(this.view.win) && (t.shiftKey = !1), this.pendingIOSKey = {
				key: e.key,
				keyCode: e.keyCode,
				mods: t
	...
	flushIOSKey(e) {
		...
		return !t || t.key == "Enter" && e && e.from < e.to && /^\S+$/.test(e.insert.toString()) ? !1 : (this.pendingIOSKey = void 0, dr(this.view.contentDOM, t.key, t.keyCode, t.mods));
	}
...
function Na(e) {
	...
	for (let t of e) {
		...
		if (r) for (let e in r) {
			let i = r[e];
			i && n(e).handlers.push(Ma(t.value, i));
		}
		if (i) for (let e in i) {
			let r = i[e];
			r && n(e).observers.push(Ma(t.value, r));
		}
	}
	for (let e in Ga) n(e).handlers.push(Ga[e]);
...
var Ba = class {
	constructor(e, t, n, r) {
		this.view = e, this.startEvent = t, this.style = n, this.mustSelect = r, this.scrollSpeed = {
			x: 0,
			y: 0
		}, this.scrolling = -1, this.lastEvent = t, this.scrollParents = rr(e.contentDOM), this.atoms = e.state.facet(li).map((t) => t(e));
		let i = e.contentDOM.ownerDocument;
		i.addEventListener("mousemove", this.move = this.move.bind(this)), i.addEventListener("mouseup", this.up = this.up.bind(this)), this.extend = t.shiftKey, this.multiple = e.state.facet(N.allowMultipleSelections) && Va(e, t), this.dragging = Ua(e, t) && to(t) == 1 ? null : !1;
	}
	start(e) {
	...
	move(e) {
		...
		if (this.dragging || this.dragging == null && za(this.startEvent, e) < 10) return;
		...
		let s = pi(this.view);
		e.clientX - s.left <= r + La ? t = -Ra(r - e.clientX) : e.clientX + s.right >= a - La && (t = Ra(e.clientX - a)), e.clientY - s.top <= i + La ? n = -Ra(i - e.clientY) : e.clientY + s.bottom >= o - La && (n = Ra(e.clientY - o)), this.setScrollSpeed(t, n);
	}
	up(e) {
	...
	select(e) {
		let { view: t } = this, n = da(this.atoms, this.style.get(e, this.extend, this.multiple));
...
var Ga = /*@__PURE__*/ Object.create(null), K = /*@__PURE__*/ Object.create(null), Ka = R.ie && R.ie_version < 15 || R.ios && R.webkit_version < 604;
function qa(e) {
	let t = e.dom.parentNode;
	if (!t) return;
	let n = t.appendChild(document.createElement("textarea"));
	n.style.cssText = "position: fixed; left: -10000px; top: 10px", n.focus(), setTimeout(() => {
		e.focus(), n.remove(), Ya(e, n.value);
	}, 50);
}
function Ja(e, t, n) {
...
function Ya(e, t) {
	...
	if (so != null && n.selection.ranges.every((e) => e.empty) && so == a.toString()) {
		let e = -1;
		r = n.changeByRange((r) => {
...
K.scroll = (e) => {
...
}, Ga.keydown = (e, t) => (e.inputState.setSelectionOrigin("select"), t.keyCode == 27 && e.inputState.tabFocusMode != 0 && (e.inputState.tabFocusMode = Date.now() + 2e3), !1), K.touchstart = (e, t) => {
	...
	let n = null;
	for (let r of e.state.facet(Vr)) if (n = r(e, t), n) break;
	if (!n && t.button == 0 && (n = no(e, t)), n) {
		let r = !e.hasFocus;
...
var Za = R.ie && R.ie_version <= 11, Qa = null, $a = 0, eo = 0;
function to(e) {
	if (!Za) return e.detail;
	let t = Qa, n = eo;
	return Qa = e, eo = Date.now(), $a = !t || n > Date.now() - 400 && Math.abs(t.clientX - e.clientX) < 2 && Math.abs(t.clientY - e.clientY) < 2 ? ($a + 1) % 3 : 1;
}
function no(e, t) {
	let n = e.posAndSideAtCoords({
		x: t.clientX,
		y: t.clientY
	}, !1), r = to(t), i = e.state.selection;
	return {
		update(e) {
		...
		get(t, a, o) {
			let s = e.posAndSideAtCoords({
				x: t.clientX,
				y: t.clientY
			}, !1), c, l = Xa(e, s.pos, s.assoc, r);
			if (n.pos != s.pos && !a) {
				let t = Xa(e, n.pos, n.assoc, r), i = Math.min(t.from, l.from), a = Math.max(t.to, l.to);
				l = i < l.from ? O.range(i, a, l.assoc) : O.range(a, i, l.assoc);
			}
			return a ? i.replaceRange(i.main.extend(l.from, l.to, l.assoc)) : o && r == 1 && i.ranges.length > 1 && (c = ro(i, s.pos)) ? c : o ? i.addRange(l) : O.create([l]);
		}
	};
}
function ro(e, t) {
...
Ga.dragstart = (e, t) => {
	...
	let { inputState: r } = e;
	return r.mouseSelection && (r.mouseSelection.dragging = !0), r.draggedContent = n, t.dataTransfer && (t.dataTransfer.setData("Text", Ja(e.state, qr, e.state.sliceDoc(n.from, n.to))), t.dataTransfer.effectAllowed = "copyMove"), !1;
}, Ga.dragend = (e) => (e.inputState.draggedContent = null, !1);
function io(e, t, n, r) {
	if (n = Ja(e.state, Kr, n), !n) return;
	let i = e.posAtCoords({
		x: t.clientX,
		y: t.clientY
	}, !1), { draggedContent: a } = e.inputState, o = r && a && Ha(e, t) ? {
		from: a.from,
		to: a.to
	} : null, s = {
		from: i,
...
Ga.drop = (e, t) => {
	...
	if (n && n.length) {
		let r = Array(n.length), i = 0, a = () => {
			++i == n.length && io(e, t, r.filter((e) => e != null).join(e.state.lineBreak), !1);
		};
	...
	}
	{
		...
		if (n) return io(e, t, n, !0), !0;
	}
	return !1;
}, Ga.paste = (e, t) => {
	if (e.state.readOnly) return !0;
	e.observer.flush();
	let n = Ka ? null : t.clipboardData;
	return n ? (Ya(e, n.getData("text/plain") || n.getData("text/uri-list")), !0) : (qa(e), !1);
};
function ao(e, t) {
...
function oo(e) {
	...
	return {
		text: Ja(e, qr, t.join(e.lineBreak)),
		ranges: n,
		linewise: r
	};
}
...
Ga.copy = Ga.cut = (e, t) => {
	...
	let { text: n, ranges: r, linewise: i } = oo(e.state);
	if (!n && !i) return !1;
	so = i ? n : null, t.type == "cut" && !e.state.readOnly && e.dispatch({
		changes: r,
		scrollIntoView: !0,
		userEvent: "delete.cut"
	});
	let a = Ka ? null : t.clipboardData;
	return a ? (a.clearData(), a.setData("text/plain", n), !0) : (ao(e, n), !1);
};
var co = /*@__PURE__*/ gt.define();
function lo(e, t) {
	let n = [];
	for (let r of e.facet(Gr)) {
		let i = r(e, t);
		i && n.push(i);
	}
...
K.focus = (e) => {
	e.inputState.lastFocusTime = Date.now(), !e.scrollDOM.scrollTop && (e.inputState.lastScrollTop || e.inputState.lastScrollLeft) && (e.scrollDOM.scrollTop = e.inputState.lastScrollTop, e.scrollDOM.scrollLeft = e.inputState.lastScrollLeft), uo(e);
}, K.blur = (e) => {
	e.observer.clearSelectionRange(), uo(e);
	...
	let i;
	if (R.chrome && R.android && (i = Pa.find((e) => e.inputType == t.inputType)) && (e.observer.delayAndroidKey(i.key, i.keyCode), i.key == "Backspace" || i.key == "Delete")) {
...
function po(e) {
	fo.has(e) || (fo.add(e), e.addEventListener("copy", () => {}), e.addEventListener("cut", () => {}));
}
var mo = [
	"pre-wrap",
	"normal",
...
var _o = class {
	...
	get widget() {
		return this._content instanceof zn ? this._content.widget : null;
	}
	...
	setHeight(e) {
		this.height != e && (Math.abs(this.height - e) > bo && (ho = !0), this.height = e);
	}
	replace(t, n, r) {
		return e.of(r);
	}
	...
	applyChanges(e, t, n, r) {
		...
		for (let o = r.length - 1; o >= 0; o--) {
			...
			l += d.from - s, s = d.from;
			let p = Ao.build(n.setDoc(a), e, l, u);
	...
	static of(t) {
		...
		let o = 0;
		return t[n - 1] == null ? (o = 1, n--) : t[n] == null && (o = 1, r++), new Do(e.of(t.slice(0, n)), o, e.of(t.slice(r)));
	}
};
function So(e, t) {
	return e == t ? e : (e.constructor != t.constructor && (ho = !0), t);
}
xo.prototype.size = 1;
var Co = /*@__PURE__*/ B.replace({}), wo = class extends xo {
	constructor(e, t, n) {
		super(e, t), this.deco = n, this.spaceAbove = 0;
	}
	mainBlock(e, t) {
		return new yo(t, this.length, e + this.spaceAbove, this.height - this.spaceAbove, this.deco || 0);
	}
	blockAt(e, t, n, r) {
		return this.spaceAbove && e < n + this.spaceAbove ? new yo(r, 0, n, this.spaceAbove, Co) : this.mainBlock(n, r);
	}
	lineAt(e, t, n, r, i) {
	...
	mainBlock(e, t) {
		return new yo(t, this.length, e + this.spaceAbove, this.height - this.spaceAbove, this.breaks);
	}
	replace(t, n, r) {
		let i = r[0];
		return r.length == 1 && (i instanceof e || i instanceof Eo && i.flags & 4) && Math.abs(this.length - i.length) < 10 ? (i instanceof Eo ? i = new e(i.length, this.height, this.spaceAbove) : i.height = this.height, this.outdated || (i.outdated = !1), i) : xo.of(r);
	}
	updateHeight(e, t = 0, n = !1, r) {
	...
	lineAt(e, t, n, r, i) {
		...
		return new yo(c.from, c.length, Math.max(r, Math.min(d, r + this.height - l)), l, 0);
	}
	forEachLine(e, t, n, r, i, a) {
		...
		for (let l = e, u = r; l <= t;) {
			...
			let r = s + c * t.length;
			a(new yo(t.from, t.length, u, r, 0)), u += r, l = t.to + 1;
		}
	}
	replace(t, n, r) {
		let i = this.length - n;
	...
	updateHeight(t, n = 0, r = !1, i) {
		...
		if (i && i.from <= n + this.length && i.more) {
			...
			for (i.from > n && r.push(new e(i.from - n - 1).updateHeight(t, n)); o <= a && i.more;) {
				...
				n < 0 && (a = -n, n = i.heights[i.index++]), s == -1 ? s = n : Math.abs(n - s) >= bo && (s = -2);
				let c = new To(e, n, a);
				c.outdated = !1, r.push(c), o += e + 1;
			}
			o <= a && r.push(null, new e(a - o).updateHeight(t, o));
			let c = xo.of(r);
			return (s < 0 || Math.abs(c.height - this.height) >= bo || Math.abs(s - this.heightMetrics(t, n).perLine) >= bo) && (ho = !0), So(this, c);
		}
	...
	replace(e, t, n) {
		...
		if (e > 0 && Oo(i, a - 1), t < this.length) {
			let e = i.length;
			this.decomposeRight(t, i), Oo(i, e);
		}
		return xo.of(i);
	}
	decomposeLeft(e, t) {
	...
	balanced(e, t) {
		return e.size > 2 * t.size || t.size > 2 * e.size ? xo.of(this.break ? [
			e,
			null,
			t
...
function Oo(e, t) {
	let n, r;
	e[t] == null && (n = e[t - 1]) instanceof Eo && (r = e[t + 1]) instanceof Eo && e.splice(t - 1, 3, new Eo(n.length + 1 + r.length));
}
var ko = 5, Ao = class e {
	constructor(e, t) {
	...
	span(e, t) {
		if (this.lineStart > -1) {
			...
			n instanceof To ? n.length += e - this.pos : (e > this.pos || !this.isCovered) && this.nodes.push(new To(e - this.pos, -1, 0)), this.writtenTo = e, t > e && (this.nodes.push(null), this.writtenTo++, this.lineStart = -1);
		}
		this.pos = t;
	}
	point(e, t, n) {
		if (e < t || n.heightRelevant) {
			...
			let a = t - e;
			n.block ? this.addBlock(new wo(a, r, n)) : (a || i || r >= ko) && this.addLineDeco(r, i, a);
	...
	enterLine() {
		...
		this.lineStart = e, this.lineEnd = t, this.writtenTo < e && ((this.writtenTo < e - 1 || this.nodes[this.nodes.length - 1] == null) && this.nodes.push(this.blankContent(this.writtenTo, e - 1)), this.nodes.push(null)), this.pos > e && this.nodes.push(new To(this.pos - e, -1, 0)), this.writtenTo = this.pos;
	}
	blankContent(e, t) {
		let n = new Eo(t - e);
	...
	finish(e) {
		...
		this.lineStart > -1 && !(t instanceof To) && !this.isCovered ? this.nodes.push(new To(0, -1, 0)) : (this.writtenTo < this.pos || t == null) && this.nodes.push(this.blankContent(this.writtenTo, this.pos));
		let n = e;
		for (let e of this.nodes) e instanceof To && e.updateHeight(this.oracle, n), n += e ? e.length : 1;
		return this.nodes;
	}
...
var Mo = class {
	...
	comparePoint(e, t, n, r) {
		(e < t || n && n.heightRelevant || r && r.heightRelevant) && Hn(e, t, this.changes, 5);
	}
};
function No(e, t) {
...
var Io = class {
	...
	draw(e, t) {
		return B.replace({ widget: new Lo(this.displaySize * (t ? e.scaleY : e.scaleX), t) }).range(this.from, this.to);
	}
}, Lo = class extends In {
	constructor(e, t) {
	...
	constructor(e, t) {
		this.view = e, this.state = t, this.pixelViewport = {
			...
			top: 0,
			bottom: 0
		}, this.inView = !0, this.paddingTop = 0, this.paddingBottom = 0, this.contentDOMWidth = 0, this.contentDOMHeight = 0, this.editorHeight = 0, this.editorWidth = 0, this.scaleX = 1, this.scaleY = 1, this.scrollOffset = 0, this.scrolledToBottom = !1, this.scrollAnchorPos = 0, this.scrollAnchorHeight = -1, this.scaler = Wo, this.scrollTarget = null, this.printing = !1, this.mustMeasureContent = !0, this.defaultTextDirection = V.LTR, this.visibleRanges = [], this.mustEnforceCursorAssoc = !1;
		let n = t.facet(ai).some((e) => typeof e != "function" && e.class == "cm-lineWrapping");
		this.heightOracle = new _o(n), this.stateDeco = Go(t), this.heightMap = xo.empty().applyChanges(this.stateDeco, C.empty, this.heightOracle.setDoc(t.doc), [new hi(0, 0, 0, t.doc.length)]);
	...
	updateScaler() {
		let e = this.scaler;
		return this.scaler = this.heightMap.height <= 7e6 ? Wo : new Ko(this.heightOracle, this.heightMap, this.viewports), e.eq(this.scaler) ? 0 : 2;
	}
	updateViewportLines() {
		this.viewportLines = [], this.heightMap.forEachLine(this.viewport.from, this.viewport.to, this.heightOracle.setDoc(this.state.doc), 0, 0, (e) => {
			this.viewportLines.push(qo(e, this.scaler));
		});
	}
	update(e, t = null) {
		this.state = e.state;
		let n = this.stateDeco;
		this.stateDeco = Go(this.state);
		let r = e.changedRanges, i = hi.extendWithRanges(r, jo(n, this.stateDeco, e ? e.changes : Re.empty(this.state.doc.length))), a = this.heightMap.height, o = this.scrolledToBottom ? null : this.scrollAnchorAt(this.scrollOffset);
		go(), this.heightMap = this.heightMap.applyChanges(this.stateDeco, e.startState.doc, this.heightOracle.setDoc(this.state.doc), i), (this.heightMap.height != a || ho) && (e.flags |= 2), o ? (this.scrollAnchorPos = e.changes.mapPos(o.from, -1), this.scrollAnchorHeight = o.top) : (this.scrollAnchorPos = -1, this.scrollAnchorHeight = a);
		...
		this.viewport = s, e.flags |= this.updateForViewport(), (c || !e.changes.empty || e.flags & 2) && this.updateViewportLines(), (this.lineGaps.length || this.viewport.to - this.viewport.from > 4e3) && this.updateLineGaps(this.ensureLineGaps(this.mapLineGaps(this.lineGaps, e.changes))), e.flags |= this.computeVisibleRanges(e.changes), t && (this.scrollTarget = t), !this.mustEnforceCursorAssoc && (e.selectionSet || e.focusChanged) && e.view.lineWrapping && e.state.selection.main.empty && e.state.selection.main.assoc && !e.state.facet(Yr) && (this.mustEnforceCursorAssoc = !0);
	}
	measure() {
		...
		let f = rr(this.view.contentDOM, !1).y;
		f != this.scrollParent && (this.scrollParent = f, this.scrollAnchorHeight = -1, this.scrollOffset = 0);
		let p = this.getScrollOffset();
		this.scrollOffset != p && (this.scrollAnchorHeight = -1, this.scrollOffset = p), this.scrolledToBottom = mr(this.scrollParent || e.win);
		let m = (this.printing ? Fo : No)(t, this.paddingTop), h = m.top - this.pixelViewport.top, g = m.bottom - this.pixelViewport.bottom;
		...
		if (_ != this.inView && (this.inView = _, _ && (s = !0)), !this.inView && !this.scrollTarget && !Po(e.dom)) return 0;
		let v = o.width;
		if ((this.contentDOMWidth != v || this.editorHeight != e.scrollDOM.clientHeight) && (this.contentDOMWidth = o.width, this.editorHeight = e.scrollDOM.clientHeight, c |= 16), s) {
			...
			h > 0 && g > 0 ? l = Math.max(h, g) : h < 0 && g < 0 && (l = Math.min(h, g)), go();
			for (let n of this.viewports) {
				let i = n.from == this.viewport.from ? t : e.docView.measureVisibleLineHeights(n);
				this.heightMap = (a ? xo.empty().applyChanges(this.stateDeco, C.empty, this.heightOracle, [new hi(0, 0, 0, e.state.doc.length)]) : this.heightMap).updateHeight(r, 0, a, new vo(n.from, i));
			}
			ho && (c |= 2);
		}
	...
	getViewport(e, t) {
		let n = .5 - Math.max(-.5, Math.min(.5, e / 1e3 / 2)), r = this.heightMap, i = this.heightOracle, { visibleTop: a, visibleBottom: o } = this, s = new zo(r.lineAt(a - n * 1e3, q.ByHeight, i, 0, 0).from, r.lineAt(o + (1 - n) * 1e3, q.ByHeight, i, 0, 0).to);
		if (t) {
			let { head: e } = t.range;
			if (e < s.from || e > s.to) {
				let n = Math.min(this.editorHeight, this.pixelViewport.bottom - this.pixelViewport.top), a = r.lineAt(e, q.ByPos, i, 0, 0), o;
				o = t.y == "center" ? (a.top + a.bottom) / 2 - n / 2 : t.y == "start" || t.y == "nearest" && e < s.from ? a.top : a.bottom - n, s = new zo(r.lineAt(o - 500, q.ByHeight, i, 0, 0).from, r.lineAt(o + n + 500, q.ByHeight, i, 0, 0).to);
			}
		}
		return s;
	}
	mapViewport(e, t) {
		...
		return new zo(this.heightMap.lineAt(n, q.ByPos, this.heightOracle, 0, 0).from, this.heightMap.lineAt(r, q.ByPos, this.heightOracle, 0, 0).to);
	}
	...
	mapLineGaps(e, t) {
		...
		let n = [];
		for (let r of e) t.touchesRange(r.from, r.to) || n.push(new Io(t.mapPos(r.from), t.mapPos(r.to), r.size, r.displaySize));
		return n;
	}
	ensureLineGaps(e, t) {
		...
		let o = [], s = (r, a, c, l) => {
			...
			let f = Uo(e, (e) => e.from >= c.from && e.to <= c.to && Math.abs(e.from - r) < i && Math.abs(e.to - a) < i && !d.some((t) => e.from < t && e.to > t));
			if (!f) {
			...
			if (n) {
				...
				if (o != null) {
					let r = Ho(i, o), s = ((this.visibleBottom - this.visibleTop) / 2 + e) / t.height;
					n = r - s, a = r + s;
	...
	updateLineGaps(e) {
		Io.same(e, this.lineGaps) || (this.lineGaps = e, this.lineGapDeco = B.set(e.map((e) => e.draw(this, this.heightOracle.lineWrapping))));
	}
	...
	lineBlockAt(e) {
		return e >= this.viewport.from && e <= this.viewport.to && this.viewportLines.find((t) => t.from <= e && t.to >= e) || qo(this.heightMap.lineAt(e, q.ByPos, this.heightOracle, 0, 0), this.scaler);
	}
	lineBlockAtHeight(e) {
		return e >= this.viewportLines[0].top && e <= this.viewportLines[this.viewportLines.length - 1].bottom && this.viewportLines.find((t) => t.top <= e && t.bottom >= e) || qo(this.heightMap.lineAt(this.scaler.fromDOM(e), q.ByHeight, this.heightOracle, 0, 0), this.scaler);
	}
	getScrollOffset() {
	...
	elementAtHeight(e) {
		return qo(this.heightMap.blockAt(this.scaler.fromDOM(e), this.heightOracle, 0, 0), this.scaler);
	}
	get docHeight() {
...
function Vo({ total: e, ranges: t }, n) {
...
function Go(e) {
	let t = e.facet(oi).filter((e) => typeof e != "function"), n = e.facet(ci).filter((e) => typeof e != "function");
...
function qo(e, t) {
	...
	return new yo(e.from, e.length, n, r - n, Array.isArray(e._content) ? e._content.map((e) => qo(e, t)) : e._content);
}
var Jo = /*@__PURE__*/ k.define({ combine: (e) => e.join(" ") }), Yo = /*@__PURE__*/ k.define({ combine: (e) => e.indexOf(!0) > -1 }), Xo = /*@__PURE__*/ rn.newName(), Zo = /*@__PURE__*/ rn.newName(), Qo = /*@__PURE__*/ rn.newName(), $o = {
	"&light": "." + Zo,
	"&dark": "." + Qo
};
function es(e, t, n) {
	return new rn(t, { finish(t) {
...
var ts = /*@__PURE__*/ es("." + Xo, {
...
}, rs = R.ie && R.ie_version <= 11, is = class {
	constructor(e) {
		...
		}), window.EditContext && R.android && e.constructor.EDIT_CONTEXT !== !1 && !(R.chrome && R.chrome_version < 126) && (this.editContext = new cs(e), e.state.facet(ei) && (e.contentDOM.editContext = this.editContext.editContext)), rs && (this.onCharData = (e) => {
			this.queue.push({
				target: e.target,
				type: "characterData",
	...
	onSelectionChange(e) {
		...
		if (n.state.facet(ei) ? n.root.activeElement != this.dom : !Kn(this.dom, r)) return;
		let i = r.anchorNode && n.docView.tile.nearest(r.anchorNode);
		if (i && i.isWidget() && i.widget.ignoreEvent(e)) {
			t || (this.selectionChanged = !1);
			return;
		}
		(R.ie && R.ie_version <= 11 || R.android && R.chrome) && !n.state.selection.main.empty && r.focusNode && Jn(r.focusNode, r.focusOffset, r.anchorNode, r.anchorOffset) ? this.flushSoon() : this.flush(!1);
	}
	readSelectionRange() {
		let { view: e } = this, t = Wn(e.root);
		if (!t) return !1;
		let n = R.safari && e.root.nodeType == 11 && e.root.activeElement == this.dom && ss(this.view, t) || t;
		if (!n || this.selectionRange.eq(n)) return !1;
		let r = Kn(this.dom, n);
		return r && !this.selectionChanged && e.inputState.lastFocusTime > Date.now() - 200 && e.inputState.lastTouchTime < Date.now() - 300 && pr(this.dom, n) ? (this.view.inputState.lastFocusTime = 0, e.docView.updateSelection(), !1) : (this.selectionRange.setRange(n), r && (this.selectionChanged = !0), !0);
	}
	...
	start() {
		this.active || (this.observer.observe(this.dom, ns), rs && this.dom.addEventListener("DOMCharacterDataModified", this.onCharData), this.active = !0);
	}
	stop() {
	...
	delayAndroidKey(e, t) {
		...
		if (!this.delayedAndroidKey) {
			let e = () => {
				...
				e && (this.clearDelayedAndroidKey(), this.view.inputState.lastKeyCode = e.keyCode, this.view.inputState.lastKeyTime = Date.now(), !this.flush() && e.force && dr(this.dom, e.key, e.keyCode));
			};
	...
	flush(e = !0) {
		...
		return this.view.state == n && (t.domChanged || t.newSel && !ka(this.view.state.selection, t.newSel.main)) && this.view.update([]), r;
	}
	readMutation(e) {
		let t = this.view.docView.tile.nearest(e.target);
		if (!t || t.isWidget()) return null;
		if (t.markDirty(e.type == "attributes"), e.type == "childList") {
			let n = as(t, e.previousSibling || e.target.previousSibling, -1), r = as(t, e.nextSibling || e.target.nextSibling, 1);
			return {
	...
	update(e) {
		this.editContext && (this.editContext.update(e), e.startState.facet(ei) != e.state.facet(ei) && (e.view.contentDOM.editContext = e.state.facet(ei) ? this.editContext.editContext : null));
	}
	destroy() {
		var e, t, n;
...
function ss(e, t) {
	...
	return e.contentDOM.addEventListener("beforeinput", r, !0), e.dom.ownerDocument.execCommand("indent"), e.contentDOM.removeEventListener("beforeinput", r, !0), n ? os(e, n) : null;
}
var cs = class {
	constructor(e) {
		...
		this.handlers.textupdate = (n) => {
			...
			let l = Ea(e.state.sliceDoc(o, s), n.text, (c ? r.from : r.to) - o, c ? "end" : null);
			if (!l) {
			...
			if ((R.mac || R.android) && u.from == a - 1 && /^\. ?$/.test(n.text) && e.contentDOM.getAttribute("autocorrect") == "off" && (u = {
				...
				wa(e, u, O.single(this.toEditorPos(n.selectionStart, t), this.toEditorPos(n.selectionEnd, t)));
			}
			...
			e.dispatch({ effects: $r.of(B.set(n)) });
	...
	constructor(e = {}) {
		...
		let { dispatch: n } = e;
		this.dispatchTransactions = e.dispatchTransactions || n && ((e) => e.forEach((e) => n(e, this))) || ((e) => this.update(e)), this.dispatch = this.dispatch.bind(this), this._root = e.root || fr(e.parent) || document, this.viewState = new Ro(this, e.state || N.create(e)), e.scrollTo && e.scrollTo.is(Qr) && (this.viewState.scrollTarget = e.scrollTo.value.clip(this.viewState.state)), this.plugins = this.state.facet(ni).map((e) => new ri(e));
		for (let e of this.plugins) e.update(this);
		this.observer = new is(this), this.inputState = new Aa(this), this.inputState.ensureHandlers(this.plugins), this.docView = new Wi(this), this.mountStyles(), this.updateAttrs(), this.updateState = 0, this.requestMeasure(), (t = document.fonts) != null && t.ready && document.fonts.ready.then(() => {
	...
	update(t) {
		...
		t.some((e) => e.annotation(co)) ? (this.inputState.notifiedFocused = o, s = 1) : o != this.inputState.notifiedFocused && (this.inputState.notifiedFocused = o, c = lo(a, o), c || (s = 1));
		...
		i = gi.create(this, a, t), i.flags |= s;
		...
		try {
			...
			for (let n of t) {
				if (d && (d = d.map(n.changes)), n.scrollIntoView) {
					...
					d = new Zr(t.empty ? t : O.cursor(t.head, t.head > t.anchor ? -1 : 1), "nearest", "nearest", i, r);
				}
				for (let e of n.effects) e.is(Qr) && (d = e.value.clip(this.state));
			}
			this.viewState.update(i, d), this.bidiCache = ds.update(this.bidiCache, i.changes), i.empty || (this.updatePlugins(i), this.inputState.update(i)), n = this.docView.update(i), this.state.facet(mi) != this.styleModules && this.mountStyles(), r = this.updateAttrs(), this.showAnnouncements(t), this.docView.updateSelection(n, t.some((e) => e.isUserEvent("select.pointer")));
		} finally {
			this.updateState = 0;
		}
		if (i.startState.facet(Jo) != i.state.facet(Jo) && (this.viewState.mustMeasureContent = !0), (n || r || d || this.viewState.mustEnforceCursorAssoc || this.viewState.mustMeasureContent) && this.requestMeasure(), n && this.docViewUpdate(), !i.empty) for (let e of this.state.facet(Ur)) try {
			e(i);
		} catch (e) {
			U(this.state, e, "update listener");
		}
		(c || u) && Promise.resolve().then(() => {
			c && this.state == c.startState && this.dispatch(c), u && !Ca(this, u) && l.force && dr(this.contentDOM, l.key, l.keyCode);
		});
	}
	setState(e) {
		...
		try {
			...
			this.viewState = new Ro(this, e), this.plugins = e.facet(ni).map((e) => new ri(e)), this.pluginMap.clear();
			for (let e of this.plugins) e.update(this);
	...
	updatePlugins(e) {
		let t = e.startState.facet(ni), n = e.state.facet(ni);
		if (t != n) {
			let r = [];
			for (let i of n) {
				let n = t.indexOf(i);
				if (n < 0) r.push(new ri(i));
				else {
	...
	measure(e = !0) {
		...
		try {
			for (let e = 0;; e++) {
				if (a < 0) {
					if (mr(n || this.win)) i = -1, a = this.viewState.heightMap.height / this.viewState.scaleY;
					else {
				...
				let l = c.map((e) => {
					try {
						...
						return U(this.state, e), us;
					}
				}), u = gi.create(this, this.state, []), d = !1;
				...
				for (let e = 0; e < c.length; e++) if (l[e] != us) try {
					let t = c[e];
		...
		if (t && !t.empty) for (let e of this.state.facet(Ur)) e(t);
	}
	get themeClasses() {
		return Xo + " " + (this.state.facet(Yo) ? Qo : Zo) + " " + this.state.facet(Jo);
	}
	updateAttrs() {
		let e = fs(this, ii, { class: "cm-editor" + (this.hasFocus ? " cm-focused " : " ") + this.themeClasses }), t = {
			spellcheck: "false",
			autocorrect: "off",
			autocapitalize: "off",
			writingsuggestions: "false",
			translate: "no",
			contenteditable: this.state.facet(ei) ? "true" : "false",
			class: "cm-content",
			style: `${R.tabSize}: ${this.state.tabSize}`,
			role: "textbox",
			"aria-multiline": "true"
		};
		this.state.readOnly && (t["aria-readonly"] = "true"), fs(this, ai, t);
		let n = this.observer.ignore(() => {
			let n = Pn(this.contentDOM, this.contentAttrs, t), r = Pn(this.dom, this.editorAttrs, e);
			return n || r;
		});
	...
	mountStyles() {
		...
		rn.mount(this.root, this.styleModules.concat(ts).reverse(), t ? { nonce: t } : void 0);
	}
	readMeasured() {
	...
	moveByChar(e, t, n) {
		return fa(this, e, sa(this, e, t, n));
	}
	moveByGroup(e, t) {
		return fa(this, e, sa(this, e, t, (t) => ca(this, e.head, t)));
	}
	visualLineSide(e, t) {
	...
	moveVertically(e, t, n) {
		return fa(this, e, la(this, e, t, n));
	}
	domAtPos(e, t = 1) {
	...
	bidiSpans(e) {
		if (e.length > ls) return Fr(e.length);
		let t = this.textDirectionAt(e.from), n;
		for (let r of this.bidiCache) if (r.from == e.from && r.dir == t && (r.fresh || Or(r.isolates, n = di(this, e)))) return r.order;
		n || (n = di(this, e));
		let r = Pr(e.text, t, n);
		return this.bidiCache.push(new ds(e.from, e.to, t, n, !0, r)), r;
	}
	get hasFocus() {
		var e;
	...
	focus() {
		this.observer.ignore(() => {
			cr(this.contentDOM), this.docView.updateSelection();
		});
	}
	setRoot(e) {
	...
	static scrollIntoView(e, t = {}) {
		var n, r, i, a;
		return Qr.of(new Zr(typeof e == "number" ? O.cursor(e) : e, (n = t.y) == null ? "nearest" : n, (r = t.x) == null ? "nearest" : r, (i = t.yMargin) == null ? 5 : i, (a = t.xMargin) == null ? 5 : a));
	}
	scrollSnapshot() {
		let { scrollTop: e, scrollLeft: t } = this.scrollDOM, n = this.viewState.scrollAnchorAt(e);
		return Qr.of(new Zr(O.cursor(n.from), "start", "start", n.top - e, t, !0));
	}
	setTabFocusMode(e) {
	...
	static theme(e, t) {
		let n = rn.newName(), r = [Jo.of(n), mi.of(es(`.${n}`, e))];
		return t && t.dark && r.push(Yo.of(!0)), r;
	}
	static baseTheme(e) {
		return tt.lowest(mi.of(es("." + Xo, e, $o)));
	}
...
J.styleModule = mi, J.inputHandler = Wr, J.clipboardInputFilter = Kr, J.clipboardOutputFilter = qr, J.scrollHandler = Xr, J.focusChangeEffect = Gr, J.perLineTextDirection = Jr, J.exceptionSink = Hr, J.updateListener = Ur, J.editable = ei, J.mouseSelectionStyle = Vr, J.dragMovesSelection = Br, J.clickAddsSelectionRange = zr, J.decorations = oi, J.blockWrappers = si, J.outerDecorations = ci, J.atomicRanges = li, J.bidiIsolatedRanges = ui, J.cursorScrollMargin = /*@__PURE__*/ k.define({ combine: (e) => {
	let t = 5, n = 5;
...
} }), J.scrollMargins = fi, J.darkTheme = Yo, J.cspNonce = /*@__PURE__*/ k.define({ combine: (e) => e.length ? e[0] : "" }), J.contentAttributes = ai, J.editorAttributes = ii, J.lineWrapping = /*@__PURE__*/ J.contentAttributes.of({ class: "cm-lineWrapping" }), J.announce = /*@__PURE__*/ j.define();
var ls = 4096, us = {}, ds = class e {
	constructor(e, t, n, r, i, a) {
...
var ps = R.mac ? "mac" : R.windows ? "win" : R.linux ? "linux" : "key";
function ms(e, t) {
...
var gs = /*@__PURE__*/ tt.default(/*@__PURE__*/ J.domEventHandlers({ keydown(e, t) {
	return Ts(ys(t.state), e, t, "editor");
} })), _s = /*@__PURE__*/ k.define({ enables: gs }), vs = /*@__PURE__*/ new WeakMap();
function ys(e) {
	let t = e.facet(_s), n = vs.get(t);
	return n || vs.set(t, n = Cs(t.reduce((e, t) => e.concat(t), []))), n;
}
function bs(e, t, n) {
	return Ts(ys(e.state), t, e, n);
}
var xs = null, Ss = 4e3;
function Cs(e, t = ps) {
	...
	for (let r of e) {
		...
		if (r.any) for (let t of e) {
			...
			let { any: i } = r;
			for (let t in e) e[t].run.push((e) => i(e, ws));
		}
		let i = r[t] || r.key;
...
function Ts(e, t, n, r) {
	ws = t;
	let i = fn(t), a = Fe(T(i, 0)) == i.length && i != " ", o = "", s = !1, c = !1, l = !1;
	xs && xs.view == n && xs.scope == r && (o = xs.prefix + " ", Ia.indexOf(t.keyCode) < 0 && (c = !0, xs = null));
	...
	return f && (d(f[o + hs(i, t, !a)]) ? s = !0 : a && (t.altKey || t.metaKey || t.ctrlKey) && !(R.windows && t.ctrlKey && t.altKey) && !(R.mac && t.altKey && !(t.ctrlKey || t.metaKey)) && (p = sn[t.keyCode]) && p != i ? (d(f[o + hs(p, t, !0)]) || t.shiftKey && (m = cn[t.keyCode]) != i && m != p && d(f[o + hs(m, t, !1)])) && (s = !0) : a && t.shiftKey && d(f[o + hs(i, t, !0)]) && (s = !0), !s && d(f._any) && (s = !0)), c && (s = !0), s && l && t.stopPropagation(), ws = null, s;
}
var Es = class e {
	constructor(e, t, n, r, i) {
...
function ks(e, t, n) {
	...
	function _(e, n, r, i) {
		return new Es(t, e - c.left, n - c.top, Math.max(0, r - e), i - n);
	}
...
var js = class {
	...
	draw(e) {
		if (e.length != this.drawn.length || e.some((e, t) => !As(e, this.drawn[t]))) {
...
}, Ms = /*@__PURE__*/ k.define();
function Ns(e) {
	return [W.define((t) => new js(t, e)), Ms.of(e)];
}
var Ps = /*@__PURE__*/ k.define({ combine(e) {
	return Mt(e, {
...
function Is(e) {
	return e.startState.facet(Ps) != e.state.facet(Ps);
}
var Ls = /*@__PURE__*/ Ns({
	above: !0,
	markers(e) {
		let { state: t } = e, n = t.facet(Ps), r = [];
		for (let i of t.selection.ranges) {
			...
			if (i.empty || n.drawRangeCursor && !(a && R.ios && n.iosSelectionHandles)) {
				...
				for (let i of Es.forRange(e, t, n)) r.push(i);
			}
		}
		return r;
	},
	update(e, t) {
		...
		let n = Is(e);
		return n && Rs(e.state, t), e.docChanged || e.selectionSet || n;
	},
	mount(e, t) {
		Rs(t.state, e);
	},
...
function Rs(e, t) {
	t.style.animationDuration = e.facet(Ps).cursorBlinkRate + "ms";
}
var zs = /*@__PURE__*/ Ns({
	above: !1,
	markers(e) {
		let t = [], { main: n, ranges: r } = e.state.selection;
		for (let n of r) if (!n.empty) for (let r of Es.forRange(e, "cm-selectionBackground", n)) t.push(r);
		if (R.ios && !n.empty && e.state.facet(Ps).iosSelectionHandles) {
			for (let r of Es.forRange(e, "cm-selectionHandle cm-selectionHandle-start", O.cursor(n.from, 1))) t.push(r);
			for (let r of Es.forRange(e, "cm-selectionHandle cm-selectionHandle-end", O.cursor(n.to, 1))) t.push(r);
		}
		return t;
	},
	update(e, t) {
		return e.docChanged || e.selectionSet || e.viewportChanged || Is(e);
	},
	class: "cm-selectionLayer"
}), Bs = R.gecko && R.gecko_version == 153 ? "#ffffff01" : "transparent", Vs = /*@__PURE__*/ tt.highest(/*@__PURE__*/ J.theme({
	".cm-line": {
...
})), Hs = /*@__PURE__*/ j.define({ map(e, t) {
	return e == null ? null : t.mapPos(e);
} }), Us = /*@__PURE__*/ A.define({
	create() {
		return null;
	},
	update(e, t) {
		return e != null && (e = t.changes.mapPos(e)), t.effects.reduce((e, t) => t.is(Hs) ? t.value : e, e);
	}
}), Ws = /*@__PURE__*/ W.fromClass(class {
	constructor(e) {
	...
	update(e) {
		var t;
		let n = e.state.field(Us);
		n == null ? this.cursor != null && ((t = this.cursor) == null || t.remove(), this.cursor = null) : (this.cursor || (this.cursor = this.view.scrollDOM.appendChild(document.createElement("div")), this.cursor.className = "cm-dropCursor"), (e.startState.field(Us) != n || e.docChanged || e.geometryChanged) && this.view.requestMeasure(this.measureReq));
	}
	readPos() {
		let { view: e } = this, t = e.state.field(Us), n = t != null && e.coordsAtPos(t);
		if (!n) return null;
	...
	setDropPos(e) {
		this.view.state.field(Us) != e && this.view.dispatch({ effects: Hs.of(e) });
	}
}, { eventObservers: {
	dragover(e) {
...
var Js = class {
	...
	createDeco(e) {
		let t = new Bt(), n = t.add.bind(t);
		for (let { from: t, to: r } of qs(e, this.maxLength)) Ks(e.state.doc, this.regexp, t, r, (t, r) => this.addMatch(r, e, t, n));
		return t.finish();
	}
	updateDeco(e, t) {
		let n = 1e9, r = -1;
	...
	updateRange(e, t, n, r) {
		for (let i of e.visibleRanges) {
			...
			if (o >= a) {
				...
				else Ks(e.state.doc, this.regexp, s, c, (t, n) => this.addMatch(n, e, t, d));
				t = t.update({
					filterFrom: s,
					filterTo: c,
					filter: (e, t) => e < s || t > c,
...
}, Ys = /x/.unicode == null ? "g" : "gu", Xs = /*@__PURE__*/ RegExp("[\0-\b\n--­؜​‎‏\u2028\u2029‭‮⁦⁧⁩﻿￹-￼]", Ys), Zs = {
	0: "null",
	7: "bell",
	8: "backspace",
	10: "newline",
...
function $s() {
	...
	if (Qs == null && typeof document < "u" && document.body) {
		...
		Qs = ((e = t.tabSize) == null ? t.MozTabSize : e) != null;
	}
	return Qs || !1;
}
var ec = /*@__PURE__*/ k.define({ combine(e) {
	let t = Mt(e, {
		render: null,
		specialChars: Xs,
		addSpecialChars: null
	});
	return (t.replaceTabs = !$s()) && (t.specialChars = RegExp("	|" + t.specialChars.source, Ys)), t.addSpecialChars && (t.specialChars = RegExp(t.specialChars.source + "|" + t.addSpecialChars.source, Ys)), t;
} });
function tc(e = {}) {
	return [ec.of(e), rc()];
}
var nc = null;
function rc() {
	return nc || (nc = W.fromClass(class {
		constructor(e) {
			this.view = e, this.decorations = B.none, this.decorationCache = Object.create(null), this.decorator = this.makeDecorator(e.state.facet(ec)), this.decorations = this.decorator.createDeco(e);
		}
		makeDecorator(e) {
			return new Js({
				regexp: e.specialChars,
				decoration: (t, n, r) => {
					let { doc: i } = n.state, a = T(t[0], 0);
					if (a == 9) {
						let e = i.lineAt(r), t = n.state.tabSize, a = Zt(e.text, t, r - e.from);
						return B.replace({ widget: new sc((t - a % t) * this.view.defaultCharacterWidth / this.view.scaleX) });
					}
					return this.decorationCache[a] || (this.decorationCache[a] = B.replace({ widget: new oc(e, a) }));
				},
		...
		update(e) {
			...
			e.startState.facet(ec) == t ? this.decorations = this.decorator.updateDeco(e, this.decorations) : (this.decorator = this.makeDecorator(t), this.decorations = this.decorator.createDeco(e.view));
		}
	}, { decorations: (e) => e.decorations }));
}
var ic = "•";
function ac(e) {
	return e >= 32 ? ic : e == 10 ? "␤" : String.fromCharCode(9216 + e);
}
var oc = class extends In {
	constructor(e, t) {
	...
	toDOM(e) {
		let t = ac(this.code), n = e.state.phrase("Control character") + " " + (Zs[this.code] || "0x" + this.code.toString(16)), r = this.options.render && this.options.render(this.code, n, t);
		if (r) return r;
...
var lc = /*@__PURE__*/ B.line({ class: "cm-activeLine" }), uc = /*@__PURE__*/ W.fromClass(class {
	constructor(e) {
	...
	getDeco(e) {
		...
		for (let r of e.state.selection.ranges) {
			...
			i.from > t && (n.push(lc.range(i.from)), t = i.from);
		}
		return B.set(n);
	}
}, { decorations: (e) => e.decorations }), dc = 2e3;
function fc(e, t, n) {
	let r = Math.min(t.line, n.line), i = Math.max(t.line, n.line), a = [];
	if (t.off > dc || n.off > dc || t.col < 0 || n.col < 0) {
		...
		for (let t = r; t <= i; t++) {
			let n = e.doc.line(t), r = Qt(n.text, o, e.tabSize, !0);
			if (r < 0) a.push(O.cursor(n.to));
			else {
				let t = Qt(n.text, s, e.tabSize);
...
function mc(e, t) {
	let n = e.posAtCoords({
		x: t.clientX,
		y: t.clientY
	}, !1), r = e.state.doc.lineAt(n), i = n - r.from, a = i > dc ? -1 : i == r.length ? pc(e, t.clientX) : Zt(r.text, e.state.tabSize, n - r.from);
	return {
		line: r.number,
		col: a,
		off: i
...
function gc(e) {
	...
	return J.mouseSelectionStyle.of((e, n) => t(n) ? hc(e, n) : null);
}
var _c = {
	Alt: [18, (e) => !!e.altKey],
...
function yc(e = {}) {
	let [t, n] = _c[e.key || "Alt"], r = W.fromClass(class {
		constructor(e) {
	...
	return [r, J.contentAttributes.of((e) => {
		var t;
		return (t = e.plugin(r)) != null && t.isDown ? vc : null;
	})];
}
var bc = "-10000px", xc = class {
	constructor(e, t, n, r) {
...
var Cc = /*@__PURE__*/ k.define({ combine: (e) => {
	var t, n, r;
	return {
		...
		tooltipSpace: ((r = e.find((e) => e.tooltipSpace)) == null ? void 0 : r.tooltipSpace) || Sc
	};
} }), wc = /*@__PURE__*/ new WeakMap(), Tc = /*@__PURE__*/ W.fromClass(class {
	constructor(e) {
		...
		this.position = t.position, this.parent = t.parent, this.classes = e.themeClasses, this.createContainer(), this.measureReq = {
			...
			key: this
		}, this.resizeObserver = typeof ResizeObserver == "function" ? new ResizeObserver(() => this.measureSoon()) : null, this.manager = new xc(e, kc, (e, t) => this.createTooltip(e, t), (e) => {
	...
	createTooltip(e, t) {
		...
		return n.dom.style.position = this.position, n.dom.style.top = bc, n.dom.style.left = "0px", this.container.insertBefore(n.dom, r), n.mount && n.mount(this.view), this.resizeObserver && this.resizeObserver.observe(n.dom), n;
	}
	destroy() {
		var e, t, n;
	...
	readMeasure() {
		...
		let r = this.view.scrollDOM.getBoundingClientRect(), i = pi(this.view);
		return {
			visible: {
				left: r.left + i.left,
				top: r.top + i.top,
	...
	writeMeasure(e) {
		...
		for (let s = 0; s < this.manager.tooltips.length; s++) {
			...
			if (ee < g && l.resize !== !1) {
				...
				wc.set(l, g), u.style.height = (g = ee) / a + "px";
			...
			if (this.position == "absolute" ? (u.style.top = (x - e.parent.top) / a + "px", Ec(u, (y - e.parent.left) / i)) : (u.style.top = x / a + "px", Ec(u, y / i)), p) {
	...
	maybeMeasure() {
		if (this.manager.tooltips.length && (this.view.inView && this.view.requestMeasure(this.measureReq), this.inView != this.view.inView && (this.inView = this.view.inView, !this.inView))) for (let e of this.manager.tooltipViews) e.dom.style.top = bc;
	}
...
var Dc = /*@__PURE__*/ J.baseTheme({
	...
	x: 0,
	y: 0
}, kc = /*@__PURE__*/ k.define({ enables: [Tc, Dc] }), Ac = /*@__PURE__*/ k.define({ combine: (e) => e.reduce((e, t) => e.concat(t), []) }), jc = class e {
	static create(t) {
		return new e(t);
	}
	constructor(e) {
		this.view = e, this.mounted = !1, this.dom = document.createElement("div"), this.dom.classList.add("cm-tooltip-hover"), this.manager = new xc(e, Ac, (e, t) => this.createHostedView(e, t), (e) => e.dom.remove());
	}
	...
	get tooltip() {
		let e = this.view.plugin(Tc), t = e ? e.manager.tooltips.findIndex((e) => e.create == jc.create) : -1;
	...
	mousemove(e) {
		...
		if (r.length && !this.locked.has(r) && i && !Ic(i.dom, e) || this.pending) {
			let { pos: i } = r[0] || this.pending, a = (n = (t = r[0]) == null ? void 0 : t.end) == null ? i : n;
			(i == a ? this.view.posAtCoords(this.lastMove) != i : !Lc(this.view, i, a, e.clientX, e.clientY)) && (this.view.dispatch({ effects: this.setHover.of([]) }), this.pending = null);
		}
	}
	mouseleave(e) {
...
function Ic(e, t) {
	...
	return t.clientX >= n - Fc && t.clientX <= r + Fc && t.clientY >= i - Fc && t.clientY <= a + Fc;
}
...
function Rc(e, t = {}) {
	let n = j.define(), r = /* @__PURE__ */ new WeakMap(), i = A.define({
		create() {
			return [];
		},
		update(e, a) {
			...
			for (let t of a.effects) t.is(n) && (e = t.value, o = void 0), (t.is(Vc) && !t.value || t.value == i) && (e = []);
			return e.length && o && r.set(e, o), e;
		},
		provide: (e) => Ac.from(e)
	}), a = W.define((a) => new Pc(a, e, i, r, n, t.hoverTime || 300));
	return {
		active: i,
		extension: [
			i,
...
function zc(e, t, n, r = {}) {
	var i;
	let a = e.state.facet(Nc).map((t) => e.plugin(t)).filter((e) => !!e);
...
var Vc = /*@__PURE__*/ j.define(), Hc = /*@__PURE__*/ k.define({ combine(e) {
	let t, n;
...
var Wc = /*@__PURE__*/ W.fromClass(class {
	constructor(e) {
		this.input = e.state.facet(qc), this.specs = this.input.filter((e) => e), this.panels = this.specs.map((t) => t(e));
		let t = e.state.facet(Hc);
		this.top = new Gc(e, !0, t.topContainer), this.bottom = new Gc(e, !1, t.bottomContainer), this.top.sync(this.panels.filter((e) => e.top)), this.bottom.sync(this.panels.filter((e) => !e.top));
		for (let e of this.panels) e.dom.classList.add("cm-panel"), e.mount && e.mount();
	}
	update(e) {
		let t = e.state.facet(Hc);
		this.top.container != t.topContainer && (this.top.sync([]), this.top = new Gc(e.view, !0, t.topContainer)), this.bottom.container != t.bottomContainer && (this.bottom.sync([]), this.bottom = new Gc(e.view, !1, t.bottomContainer)), this.top.syncClasses(), this.bottom.syncClasses();
...
var qc = /*@__PURE__*/ k.define({ enables: Wc });
function Jc(e, t) {
	let n, r = new Promise((e) => n = e), i = (e) => $c(e, t, n);
	e.state.field(Xc, !1) ? e.dispatch({ effects: Zc.of(i) }) : e.dispatch({ effects: j.appendConfig.of(Xc.init(() => [i])) });
	let a = Qc.of(i);
	return {
		close: a,
		result: r.then((t) => ((e.win.queueMicrotask || ((t) => e.win.setTimeout(t, 10)))(() => {
			e.state.field(Xc).indexOf(i) > -1 && e.dispatch({ effects: a });
		}), t))
	};
}
function Yc(e, t) {
	let n = e.state.field(Xc, !1) || [];
	for (let r of n) {
		let n = Uc(e, r);
...
var Xc = /*@__PURE__*/ A.define({
	create() {
		return [];
	},
	update(e, t) {
		for (let n of t.effects) n.is(Zc) ? e = [n.value].concat(e) : n.is(Qc) && (e = e.filter((e) => e != n.value));
		return e;
	},
	provide: (e) => qc.computeN([e], (t) => t.field(e))
}), Zc = /*@__PURE__*/ j.define(), Qc = /*@__PURE__*/ j.define();
function $c(e, t, n) {
...
el.prototype.elementClass = "", el.prototype.toDOM = void 0, el.prototype.mapMode = E.TrackBefore, el.prototype.startSide = el.prototype.endSide = -1, el.prototype.point = !0;
var tl = /*@__PURE__*/ k.define(), nl = /*@__PURE__*/ k.define(), rl = {
	class: "",
	...
	domEventHandlers: {},
	side: "before"
}, il = /*@__PURE__*/ k.define();
function al(e) {
	return [sl(), il.of(yn(yn({}, rl), e))];
}
var ol = /*@__PURE__*/ k.define({ combine: (e) => e.some((e) => e) });
function sl(e) {
	let t = [cl];
	return e && e.fixed === !1 && t.push(ol.of(!0)), t;
}
var cl = /*@__PURE__*/ W.fromClass(class {
	constructor(e) {
		this.view = e, this.domAfter = null, this.prevViewport = e.viewport, this.dom = document.createElement("div"), this.dom.className = "cm-gutters cm-gutters-before", this.dom.setAttribute("aria-hidden", "true"), this.dom.style.minHeight = this.view.contentHeight / this.view.scaleY + "px", this.gutters = e.state.facet(il).map((t) => new fl(e, t)), this.fixed = !e.state.facet(ol);
	...
	update(e) {
		...
		this.view.state.facet(ol) != !this.fixed && (this.fixed = !this.fixed, this.dom.style.position = this.fixed ? "sticky" : "", this.domAfter && (this.domAfter.style.position = this.fixed ? "sticky" : "")), this.prevViewport = e.view.viewport;
	}
	syncGutters(e) {
		let t = this.dom.nextSibling;
		e && (this.dom.remove(), this.domAfter && this.domAfter.remove());
		let n = P.iter(this.view.state.facet(tl), this.view.viewport.from), r = [], i = this.gutters.map((e) => new dl(e, this.view.viewport, -this.view.documentPadding.top));
	...
	updateGutters(e) {
		let t = e.startState.facet(il), n = e.state.facet(il), r = e.docChanged || e.heightChanged || e.viewportChanged || !P.eq(e.startState.facet(tl), e.state.facet(tl), e.view.viewport.from, e.view.viewport.to);
		if (t == n) for (let t of this.gutters) t.update(e) && (r = !0);
			...
			for (let r of n) {
				let n = t.indexOf(r);
				n < 0 ? i.push(new fl(this.view, r)) : (this.gutters[n].update(e), i.push(this.gutters[n]));
			}
...
var dl = class {
	...
	line(e, t, n) {
		let r = [];
		ul(this.cursor, r, t.from), n.length && (r = r.concat(n));
	...
	constructor(e, t) {
		...
		this.markers = ll(t.markers(e)), t.initialSpacer && (this.spacer = new pl(e, 0, 0, [t.initialSpacer(e)]), this.dom.appendChild(this.spacer.dom), this.spacer.dom.style.cssText += "visibility: hidden; pointer-events: none");
	}
	update(e) {
		let t = this.markers;
	...
	update(e, t, n, r) {
		this.height != t && (this.height = t, this.dom.style.height = t + "px"), this.above != n && (this.dom.style.marginTop = (this.above = n) ? n + "px" : ""), ml(this.markers, r) || this.setMarkers(e, r);
	}
	setMarkers(e, t) {
...
var hl = /*@__PURE__*/ k.define(), gl = /*@__PURE__*/ k.define(), _l = /*@__PURE__*/ k.define({ combine(e) {
	return Mt(e, {
		formatNumber: String,
		domEventHandlers: {}
...
function yl(e, t) {
	return e.state.facet(_l).formatNumber(t, e.state);
}
var bl = /*@__PURE__*/ il.compute([_l], (e) => ({
	class: "cm-lineNumbers",
	renderEmptyElements: !1,
	markers(e) {
		return e.state.facet(hl);
	},
	lineMarker(e, t, n) {
		return n.some((e) => e.toDOM) ? null : new vl(yl(e, e.state.doc.lineAt(t.from).number));
	},
	widgetMarker: (e, t, n) => {
		for (let r of e.state.facet(gl)) {
			let i = r(e, t, n);
			if (i) return i;
		}
		return null;
	...
	initialSpacer(e) {
		return new vl(yl(e, Sl(e.state.doc.lines)));
	},
	updateSpacer(e, t) {
		let n = yl(t.view, Sl(t.view.state.doc.lines));
		return n == e.number ? e : new vl(n);
	},
	domEventHandlers: e.facet(_l).domEventHandlers,
	side: "before"
}));
function xl(e = {}) {
	return [
...
var Cl = /*@__PURE__*/ new class extends el {
	constructor() {
		super(...arguments), this.elementClass = "cm-activeLineGutter";
	}
}(), wl = /*@__PURE__*/ tl.compute(["selection"], (e) => {
	let t = [], n = -1;
...
var El = 0, Dl = class e {
	constructor(e, t, n, r) {
		this.name = e, this.set = t, this.base = n, this.modified = r, this.id = El++;
	}
	toString() {
		let { name: e } = this;
	...
	constructor(e) {
		this.name = e, this.instances = [], this.id = Ol++;
	}
	static get(t, n) {
		if (!n.length) return t;
		let r = n[0].instances.find((e) => e.base == t && Al(n, e.modified));
		if (r) return r;
		let i = [], a = new Dl(t.name, i, t, n);
...
function Ml(e) {
	...
	for (let n in e) {
		...
		for (let e of n.split(" ")) if (e) {
			...
			t[s] = new Pl(r, i, o > 0 ? n.slice(0, o) : null).sort(t[s]);
		}
	}
	return Nl.add(t);
}
var Nl = new n({ combine(e, t) {
	let n, r, i;
	for (; e || t;) {
		if (!e || t && e.depth >= t.depth ? (i = t, t = t.next) : (i = e, e = e.next), n && n.mode == i.mode && !i.context && !n.context) continue;
		let a = new Pl(i.tags, i.mode, i.context);
		n ? n.next = a : r = a, n = a;
	}
	return r;
} }), Pl = class {
...
function Ll(e, t, n, r = 0, i = e.length) {
	let a = new Rl(r, Array.isArray(t) ? t : [t], n);
...
var Rl = class {
	...
	highlightRange(e, t, r, i, a) {
		...
		let l = i, u = zl(e) || Pl.empty, d = Il(a, u.tags);
...
function zl(e) {
	let t = e.type.prop(Nl);
	for (; t && t.context && !e.matchContext(t.context);) t = t.next;
	return t || null;
}
var Y = Dl.define, Bl = Y(), Vl = Y(), Hl = Y(Vl), Ul = Y(Vl), Wl = Y(), Gl = Y(Wl), Kl = Y(Wl), ql = Y(), Jl = Y(ql), Yl = Y(), Xl = Y(), Zl = Y(), Ql = Y(Zl), $l = Y(), X = {
	comment: Bl,
	lineComment: Y(Bl),
	blockComment: Y(Bl),
	docComment: Y(Bl),
	...
	unit: Y(Yl),
	modifier: Y(Yl),
	operatorKeyword: Y(Yl),
	controlKeyword: Y(Yl),
	definitionKeyword: Y(Yl),
	moduleKeyword: Y(Yl),
	operator: Xl,
	derefOperator: Y(Xl),
	arithmeticOperator: Y(Xl),
	logicOperator: Y(Xl),
	bitwiseOperator: Y(Xl),
	compareOperator: Y(Xl),
	updateOperator: Y(Xl),
	definitionOperator: Y(Xl),
	typeOperator: Y(Xl),
	controlOperator: Y(Xl),
	punctuation: Zl,
	separator: Y(Zl),
	bracket: Ql,
	angleBracket: Y(Ql),
	...
	documentMeta: Y($l),
	annotation: Y($l),
	processingInstruction: Y($l),
	definition: Dl.defineModifier("definition"),
	constant: Dl.defineModifier("constant"),
	function: Dl.defineModifier("function"),
	standard: Dl.defineModifier("standard"),
	local: Dl.defineModifier("local"),
	special: Dl.defineModifier("special")
};
for (let e in X) {
	let t = X[e];
	t instanceof Dl && (t.name = e);
}
Fl([
	{
		tag: X.link,
...
var eu, tu = /*@__PURE__*/ new n();
function nu(e) {
	return k.define({ combine: e ? (t) => t.concat(e) : void 0 });
}
var ru = /*@__PURE__*/ new n(), iu = class {
	constructor(e, t, n = [], r = "") {
		this.data = e, this.name = r, N.prototype.hasOwnProperty("tree") || Object.defineProperty(N.prototype, "tree", { get() {
			return Z(this);
		} }), this.parser = t, this.extension = [mu.of(this), N.languageData.of((e, t, n) => {
			let r = au(e, t, n), i = r.type.prop(tu);
			if (!i) return [];
			let a = e.facet(i), o = r.type.prop(ru);
			if (o) {
	...
	isActiveAt(e, t, n = -1) {
		return au(e, t, n).type.prop(tu) == this.data;
	}
	findRegions(e) {
		let t = e.facet(mu);
...
var ou = class {
	...
	startParse() {
		return this.parser.startParse(new ou(this.state.doc), this.fragments);
	}
	work(e, t) {
	...
	withoutTempSkipped(e) {
		for (let t; t = this.tempSkipped.pop();) e = lu(e, t.from, t.to);
		return e;
	}
	changes(t, n) {
	...
	updateViewport(e) {
		...
		for (let t = 0; t < this.skipped.length; t++) {
			...
			n < e.to && r > e.from && (this.fragments = lu(this.fragments, n, r), this.skipped.splice(t--, 1));
		}
...
var uu = class e {
	...
	static init(t) {
		let n = Math.min(3e3, t.doc.length), r = cu.create(t.facet(mu).parser, t, {
			from: 0,
			to: n
		});
...
iu.state = /*@__PURE__*/ A.define({
	create: uu.init,
	update(e, t) {
		for (let e of t.effects) if (e.is(iu.setState)) return e.value;
		return t.startState.facet(mu) == t.state.facet(mu) ? e.apply(t) : uu.init(t.state);
	}
});
var du = (e) => {
...
typeof requestIdleCallback < "u" && (du = (e) => {
	let t = -1, n = setTimeout(() => {
		t = requestIdleCallback(e, { timeout: 400 });
	}, 100);
	return () => t < 0 ? clearTimeout(n) : cancelIdleCallback(t);
});
var fu = typeof navigator < "u" && (eu = navigator.scheduling) != null && eu.isInputPending ? () => navigator.scheduling.isInputPending() : null, pu = /*@__PURE__*/ W.fromClass(class {
	constructor(e) {
		this.view = e, this.working = null, this.workScheduled = 0, this.chunkEnd = -1, this.chunkBudget = -1, this.work = this.work.bind(this), this.scheduleWork();
	}
	update(e) {
		let t = this.view.state.field(iu.state).context;
		(t.updateViewport(e.view.viewport) || this.view.viewport.to > t.treeLen) && this.scheduleWork(), (e.docChanged || e.selectionSet) && (this.view.hasFocus && (this.chunkBudget += 50), this.scheduleWork()), this.checkAsyncSchedule(t);
	}
	scheduleWork() {
		if (this.working) return;
		let { state: e } = this.view, t = e.field(iu.state);
		(t.tree != t.context.tree || !t.context.isDone(e.doc.length)) && (this.working = du(this.work));
	}
	work(e) {
		this.working = null;
		let t = Date.now();
		if (this.chunkEnd < t && (this.chunkEnd < 0 || this.view.hasFocus) && (this.chunkEnd = t + 3e4, this.chunkBudget = 3e3), this.chunkBudget <= 0) return;
		let { state: n, viewport: { to: r } } = this.view, i = n.field(iu.state);
		if (i.tree == i.context.tree && i.context.isDone(r + 1e5)) return;
		let a = Date.now() + Math.min(this.chunkBudget, 100, e && !fu ? Math.max(25, e.timeRemaining() - 5) : 1e9), o = i.context.treeLen < r && n.doc.length > r + 1e3, s = i.context.work(() => fu && fu() || Date.now() > a, r + (o ? 0 : 1e5));
		this.chunkBudget -= Date.now() - t, (s || this.chunkBudget <= 0) && (i.context.takeTree(), this.view.dispatch({ effects: iu.setState.of(new uu(i.context)) })), this.chunkBudget > 0 && !(s && !o) && this.scheduleWork(), this.checkAsyncSchedule(i.context);
	}
...
}), hu = /*@__PURE__*/ k.define(), gu = /*@__PURE__*/ k.define({ combine: (e) => {
	if (!e.length) return "  ";
	let t = e[0];
...
function vu(e, t) {
	let n = "", r = e.tabSize, i = e.facet(gu)[0];
	if (i == "	") {
		for (; t >= r;) n += "	", t -= r;
		i = " ";
	}
...
function yu(e, t) {
	e instanceof N && (e = new bu(e));
	for (let n of e.state.facet(hu)) {
		let r = n(e, t);
		if (r !== void 0) return r;
	}
	let n = Z(e.state);
	return n.length >= t ? Su(e, n, t) : null;
}
var bu = class {
	constructor(e, t = {}) {
		this.state = e, this.options = t, this.unit = _u(e);
	}
	lineAt(e, t = 1) {
	...
	countColumn(e, t = e.length) {
		return Zt(e, this.state.tabSize, t);
	}
	lineIndent(e, t = 1) {
...
function Tu(e) {
	...
	if (r && (i = r.type.prop(n.closedBy))) {
		...
		return (e) => Au(e, !0, 1, void 0, n && !wu(e) ? t.from : void 0);
	}
	return e.parent == null ? Eu : null;
}
function Eu() {
	return 0;
}
var Du = class e extends bu {
	constructor(e, t, n) {
...
function Au(e, t, n, r, i) {
	let a = e.textAfter, o = a.match(/^\s*/)[0].length, s = r && a.slice(o, o + r.length) == r || i == e.pos + o, c = t ? ku(e) : null;
...
function Mu() {
	return N.transactionFilter.of((e) => {
		...
		for (let { head: e } of o.selection.ranges) {
			...
			let n = yu(o, t.from);
			if (n == null) continue;
			let r = /^\s*/.exec(t.text)[0], i = vu(o, n);
			r != i && c.push({
				from: t.from,
				to: t.from + r.length,
				insert: i
...
var Nu = /*@__PURE__*/ k.define(), Pu = /*@__PURE__*/ new n();
function Fu(e, t, n) {
	let r = Z(e);
	...
	for (let o = i; o; o = o.next) {
		...
		if (a && i.from < t) break;
		let s = i.type.prop(Pu);
		if (s && (i.to < r.length - 50 || r.length == e.doc.length || !Iu(i))) {
			let r = s(i, e);
...
var zu = /*@__PURE__*/ j.define({ map: Ru }), Bu = /*@__PURE__*/ j.define({ map: Ru });
function Vu(e) {
	let t = [];
	for (let { head: n } of e.state.selection.ranges) t.some((e) => e.from <= n && e.to >= n) || t.push(e.lineBlockAt(n));
	return t;
}
var Hu = /*@__PURE__*/ A.define({
	create() {
		return B.none;
	},
	update(e, t) {
		t.isUserEvent("delete") && t.changes.iterChangedRanges((t, n) => e = Uu(e, t, n)), e = e.map(t.changes);
		let n = [];
		for (let r of t.effects) r.is(zu) && !Gu(e, r.value.from, r.value.to) ? n.push(r.value) : r.is(Bu) && (e = e.update({
			filter: (e, t) => r.value.from != e || r.value.to != t,
			filterFrom: r.value.from,
			filterTo: r.value.to
		}));
		if (n.length) {
			let { preparePlaceholder: r } = t.state.facet(Qu), i = n.map((e) => (r ? B.replace({ widget: new nd(r(t.state, e)) }) : td).range(e.from, e.to));
			e = e.update({ add: i });
		}
		return t.selection && (e = Uu(e, t.selection.main.head)), e;
	},
...
function Wu(e, t, n) {
	var r;
	let i = null;
	return (r = e.field(Hu, !1)) == null || r.between(t, n, (e, t) => {
		(!i || i.from > e) && (i = {
			from: e,
			to: t
		});
...
function Ku(e, t) {
	return e.field(Hu, !1) ? t : t.concat(j.appendConfig.of($u()));
}
var qu = (e) => {
	for (let t of Vu(e)) {
		let n = Lu(e.state, t.from, t.to);
		if (n) return e.dispatch({ effects: Ku(e.state, [zu.of(n), Yu(e, n)]) }), !0;
	}
	return !1;
}, Ju = (e) => {
	if (!e.state.field(Hu, !1)) return !1;
	let t = [];
	for (let n of Vu(e)) {
		let r = Wu(e.state, n.from, n.to);
		r && t.push(Bu.of(r), Yu(e, r, !1));
	}
...
var Xu = [
	...
	},
	{
		...
		run: (e) => {
			...
			for (let r = 0; r < t.doc.length;) {
				let i = e.lineBlockAt(r), a = Lu(t, i.from, i.to);
				a && n.push(zu.of(a)), r = (a ? e.lineBlockAt(a.to) : i).to + 1;
			}
			return n.length && e.dispatch({ effects: Ku(e.state, n) }), !!n.length;
		}
	},
	{
		key: "Ctrl-Alt-]",
		run: (e) => {
			let t = e.state.field(Hu, !1);
	...
	placeholderText: "…"
}, Qu = /*@__PURE__*/ k.define({ combine(e) {
	return Mt(e, Zu);
} });
function $u(e) {
	let t = [Hu, od];
	return e && t.push(Qu.of(e)), t;
}
function ed(e, t) {
	let { state: n } = e, r = n.facet(Qu), i = (t) => {
		let n = e.lineBlockAt(e.posAtDOM(t.target)), r = Wu(e.state, n.from, n.to);
		r && e.dispatch({ effects: Bu.of(r) }), t.preventDefault();
	};
...
var td = /*@__PURE__*/ B.replace({ widget: /*@__PURE__*/ new class extends In {
	toDOM(e) {
		return ed(e, null);
	}
}() }), nd = class extends In {
...
function ad(e = {}) {
	let t = yn(yn({}, rd), e), n = new id(t, !0), r = new id(t, !1), i = W.fromClass(class {
		constructor(e) {
			this.from = e.viewport.from, this.markers = this.buildMarkers(e);
		}
		update(e) {
			(e.docChanged || e.viewportChanged || e.startState.facet(mu) != e.state.facet(mu) || e.startState.field(Hu, !1) != e.state.field(Hu, !1) || Z(e.startState) != Z(e.state) || t.foldingChanged(e)) && (this.markers = this.buildMarkers(e.view));
		}
		buildMarkers(e) {
			let t = new Bt();
			for (let i of e.viewportLineBlocks) {
				let a = Wu(e.state, i.from, i.to) ? r : Lu(e.state, i.from, i.to) ? n : null;
	...
	return [
		...
		al({
			...
			domEventHandlers: yn(yn({}, a), {}, { click: (e, t, n) => {
				if (a.click && a.click(e, t, n)) return !0;
				let r = Wu(e.state, t.from, t.to);
				if (r) return e.dispatch({ effects: Bu.of(r) }), !0;
				let i = Lu(e.state, t.from, t.to);
...
var od = /*@__PURE__*/ J.baseTheme({
	...
	constructor(e, t) {
		...
		this.scope = a instanceof iu ? (e) => e.prop(tu) == a.data : a ? (e) => e == a : void 0, this.style = Fl(e.map((e) => ({
			tag: e.tag,
			class: e.class || r(Object.assign({}, e, { tag: null }))
		})), { all: i }).style, this.module = n ? new rn(n) : null, this.themeType = t.themeType;
	}
	static define(t, n) {
		return new e(t, n || {});
	}
}, cd = /*@__PURE__*/ k.define(), ld = /*@__PURE__*/ k.define({ combine(e) {
	return e.length ? [e[0]] : null;
} });
function ud(e) {
	let t = e.facet(cd);
	return t.length ? t : e.facet(ld);
}
function dd(e, t) {
	let n = [pd], r;
	return e instanceof sd && (e.module && n.push(J.styleModule.of(e.module)), r = e.themeType), t != null && t.fallback ? n.push(ld.of(e)) : r ? n.push(cd.computeN([J.darkTheme], (t) => t.facet(J.darkTheme) == (r == "dark") ? [e] : [])) : n.push(cd.of(e)), n;
}
var fd = class {
	constructor(e) {
		this.markCache = Object.create(null), this.tree = Z(e.state), this.decorations = this.buildDeco(e, ud(e.state)), this.decoratedTo = e.viewport.to;
	}
	update(e) {
		let t = Z(e.state), n = ud(e.state), r = n != ud(e.startState), { viewport: i } = e.view, a = e.changes.mapPos(this.decoratedTo, 1);
	...
	buildDeco(e, t) {
		...
		let n = new Bt();
		for (let { from: r, to: i } of e.visibleRanges) Ll(this.tree, t, (e, t, r) => {
			n.add(e, t, this.markCache[r] || (this.markCache[r] = B.mark({ class: r })));
		}, r, i);
		return n.finish();
	}
}, pd = /*@__PURE__*/ tt.high(/*@__PURE__*/ W.fromClass(fd, { decorations: (e) => e.decorations })), md = /*@__PURE__*/ sd.define([
	{
		tag: X.meta,
		color: "#404740"
	},
...
]), hd = /*@__PURE__*/ J.baseTheme({
	"&.cm-focused .cm-matchingBracket": { backgroundColor: "#328c8252" },
	"&.cm-focused .cm-nonmatchingBracket": { backgroundColor: "#bb555544" }
}), gd = 1e4, _d = "()[]{}", vd = /*@__PURE__*/ k.define({ combine(e) {
	return Mt(e, {
		afterCursor: !0,
		brackets: _d,
		maxScanDistance: gd,
...
} }), yd = /*@__PURE__*/ B.mark({ class: "cm-matchingBracket" }), bd = /*@__PURE__*/ B.mark({ class: "cm-nonmatchingBracket" });
function xd(e) {
	let t = [], n = e.matched ? yd : bd;
...
function Sd(e) {
	...
	for (let r of e.selection.ranges) {
		if (!r.empty) continue;
		let i = Od(e, r.head, -1, n) || r.head > 0 && Od(e, r.head - 1, 1, n) || n.afterCursor && (Od(e, r.head, 1, n) || r.head < e.doc.length && Od(e, r.head + 1, -1, n));
		i && (t = t.concat(n.renderMatch(i, e)));
	}
	return B.set(t, !0);
}
var Cd = [/* @__PURE__ */ W.fromClass(class {
	constructor(e) {
		this.paused = !1, this.decorations = Sd(e.state);
	}
	update(e) {
		(e.docChanged || e.selectionSet || this.paused) && (e.view.composing ? (this.decorations = this.decorations.map(e.changes), this.paused = !0) : (this.decorations = Sd(e.state), this.paused = !1));
	}
}, { decorations: (e) => e.decorations }), hd];
function wd(e = {}) {
	return [vd.of(e), Cd];
}
var Td = /*@__PURE__*/ new n();
function Ed(e, t, r) {
...
function Dd(e) {
	let t = e.type.prop(Td);
	return t ? t(e.node) : e;
}
function Od(e, t, n, r = {}) {
	let i = r.maxScanDistance || gd, a = r.brackets || _d, o = Z(e), s = o.resolveInner(t, n);
	for (let r = s; r; r = r.parent) {
		let i = Ed(r.type, n, a);
		if (i && r.from < r.to) {
			let o = Dd(r);
			if (o && (n > 0 ? t >= o.from && t < o.to : t > o.from && t <= o.to)) return kd(e, t, n, r, o, i, a);
		}
	}
	return Ad(e, t, n, o, s.type, i, a);
}
function kd(e, t, n, r, i, a, o) {
	let s = r.parent, c = {
		from: i.from,
		to: i.to
...
var Md = class {
	...
	column() {
		return this.lastColumnPos < this.start && (this.lastColumnValue = jd(this.string, this.start, this.tabSize, this.lastColumnPos, this.lastColumnValue), this.lastColumnPos = this.start), this.lastColumnValue;
	}
	indentation() {
		var e;
		return (e = this.overrideIndent) == null ? jd(this.string, null, this.tabSize) : e;
	}
	match(e, t, n) {
		if (typeof e == "string") {
...
function Nd(e) {
	return {
		...
		copyState: e.copyState || Pd,
		indent: e.indent || (() => null),
		languageData: e.languageData || {},
		tokenTable: e.tokenTable || Hd,
...
var Fd = /*@__PURE__*/ new WeakMap(), Id = class e extends iu {
	constructor(e) {
		let t = nu(e.languageData), r = Nd(e), i, a = new class extends ce {
			createParse(e, t, n) {
				return new Bd(i, e, t, n);
			}
		}();
		super(t, a, [], e.name), this.topNode = Qd(t, this), i = this, this.streamParser = r, this.stateAfter = new n({ perNode: !0 }), this.tokenTable = e.tokenTable ? new Jd(r.tokenTable) : Yd;
	}
	static define(t) {
		return new e(t);
	}
	getIndent(e) {
		...
		n && (t = Fd.get(e.state), t != null && t < e.pos - 1e4 && (t = void 0));
		let r = Ld(this, e.node.tree, e.node.from, e.node.from, t == null ? e.pos : t), i, a;
		...
		for (; i < e.pos;) {
			...
			if (t.length) {
				let i = n ? n(t.from) : -1, o = new Md(t.text, e.state.tabSize, e.unit, i < 0 ? void 0 : i);
				for (; o.pos < r - t.from;) Vd(this.streamParser.token, o, a);
			} else this.streamParser.blankLine(a, e.unit);
			if (r == e.pos) break;
			i = t.to + 1;
		}
		let o = e.lineAt(e.pos);
		return n && t == null && Fd.set(e.state, o.from), this.streamParser.indent(a, /^\s*(.*)/.exec(o.text)[1], e);
	}
	get allowsNesting() {
		return !1;
	}
...
function Ld(e, t, n, r, i) {
	...
	for (let a = t.children.length - 1; a >= 0; a--) {
		let o = t.children[a], s = n + t.positions[a], c = o instanceof u && s < i && Ld(e, o, s, r, i);
		if (c) return c;
	}
	return null;
}
...
function zd(e, t, n, r, i) {
	for (let i of t) {
		let t = i.from + (i.openStart ? 25 : 0), a = i.to - (i.openEnd ? 25 : 0), o = t <= n && a > n && Ld(e, i.tree, 0 - i.offset, n, a), s;
		if (o && o.pos <= r && (s = Rd(e, i.tree, n + i.offset, o.pos + i.offset, !1))) return {
			state: o.state,
			tree: s
		};
	}
	return {
		state: e.streamParser.startState(i ? _u(i) : 4),
		tree: u.empty
	};
}
var Bd = class {
	constructor(e, t, n, r) {
		...
		let i = cu.get(), a = r[0].from, { state: o, tree: s } = zd(e, n, a, this.to, i == null ? void 0 : i.state);
		...
		i && this.parsedPos < i.viewport.from - 1e5 && r.some((e) => e.from <= i.viewport.from && e.to >= i.viewport.from) && (this.state = this.lang.streamParser.startState(_u(i.state)), i.skipUntilInView(this.parsedPos, i.viewport.from), this.parsedPos = i.viewport.from), this.moveRangeIndex();
	}
	advance() {
		let e = cu.get(), t = this.stoppedAt == null ? this.to : Math.min(this.to, this.stoppedAt), n = Math.min(t, this.chunkStart + 512);
	...
	parseLine(e) {
		let { line: t, end: n } = this.nextLine(), r = 0, { streamParser: i } = this.lang, a = new Md(t, e ? e.state.tabSize : 4, e ? _u(e.state) : 2);
		if (a.eol()) i.blankLine(this.state, a.indentUnit);
		else for (; !a.eol();) {
			let e = Vd(i.token, a, this.state);
...
var Hd = /*@__PURE__*/ Object.create(null), Ud = [a.none], Wd = /*@__PURE__*/ new o(Ud), Gd = [], Kd = /*@__PURE__*/ Object.create(null), qd = /*@__PURE__*/ Object.create(null);
for (let [e, t] of [
...
]) qd[e] = /*@__PURE__*/ Zd(Hd, t);
var Jd = class {
	constructor(e) {
		this.extra = e, this.table = Object.assign(Object.create(null), qd);
	}
	resolve(e) {
		return e ? this.table[e] || (this.table[e] = Zd(this.extra, e)) : 0;
	}
}, Yd = /*@__PURE__*/ new Jd(Hd);
function Xd(e, t) {
...
function Zd(e, t) {
	...
	let r = t.replace(/ /g, "_"), i = r + " " + n.map((e) => e.id), o = Kd[i];
	if (o) return o.id;
	let s = Kd[i] = a.define({
		id: Ud.length,
		name: r,
	...
	return Ud.push(s), s.id;
}
function Qd(e, t) {
	let n = a.define({
		id: Ud.length,
		name: "Document",
		props: [tu.add(() => e), xu.add(() => (e) => t.getIndent(e))],
		top: !0
	});
	return Ud.push(n), n;
}
...
var df = /*@__PURE__*/ gt.define(), ff = /*@__PURE__*/ gt.define(), pf = /*@__PURE__*/ k.define(), mf = /*@__PURE__*/ k.define({ combine(e) {
	return Mt(e, {
		minDepth: 100,
		newGroupDelay: 500,
		joinToEvent: (e, t) => t
	...
	update(e, t) {
		...
		if ((i == "full" || i == "before") && (e = e.isolate()), t.annotation(yt.addToHistory) === !1) return t.changes.empty ? e : e.addMapping(t.changes.desc);
		let a = Sf.fromTransaction(t), o = t.annotation(yt.time), s = t.annotation(yt.userEvent);
...
var vf = /*@__PURE__*/ _f(0, !1), yf = /*@__PURE__*/ _f(1, !1), bf = /*@__PURE__*/ _f(0, !0), xf = /*@__PURE__*/ _f(1, !0), Sf = class e {
	...
	static fromJSON(t) {
		return new e(t.changes && Re.fromJSON(t.changes), [], t.mapped && Le.fromJSON(t.mapped), t.startSelection && O.fromJSON(t.startSelection), t.selectionsAfter.map(O.fromJSON));
	}
...
function Mf(e, t, n) {
	...
	return new Sf(i, j.mapEffects(e.effects, t), o, e.startSelection.map(a), r);
}
...
var Wf = (e) => Uf(e, !Q(e)), Gf = (e) => Uf(e, Q(e));
...
function qf(e, t, r) {
	...
	for (let n = t.head;;) {
		...
		if (!t) break;
		Kf(e, t, a) ? i = t : n = r ? t.to : t.from;
	}
	let o = i.type.prop(a), s, c;
	return c = o && (s = r ? Od(e, i.from, 1) : Od(e, i.to, -1)) && s.matched ? r ? s.end.to : s.end.from : r ? i.to : i.from, O.cursor(c, r ? -1 : 1);
}
var Jf = (e) => Rf(e, (t) => qf(e.state, t, !Q(e))), Yf = (e) => Rf(e, (t) => qf(e.state, t, Q(e)));
function Xf(e, t) {
	return Rf(e, (n) => {
...
function ep(e, t) {
	let n = $f(e), { state: r } = e, i = If(r.selection, (r) => r.empty ? e.moveVertically(r, t, n.height) : zf(r, t));
...
var ip = (e) => Rf(e, (t) => rp(e, t, !0)), ap = (e) => Rf(e, (t) => rp(e, t, !1)), op = (e) => Rf(e, (t) => rp(e, t, !Q(e))), sp = (e) => Rf(e, (t) => rp(e, t, Q(e))), cp = (e) => Rf(e, (t) => O.cursor(e.lineBlockAt(t.head).from, 1)), lp = (e) => Rf(e, (t) => O.cursor(e.lineBlockAt(t.head).to, -1));
function up(e, t, n) {
	let r = !1, i = If(e.selection, (t) => {
		let i = Od(e, t.head, -1) || Od(e, t.head, 1) || t.head > 0 && Od(e, t.head - 1, 1) || t.head < e.doc.length && Od(e, t.head + 1, -1);
		if (!i || !i.end) return t;
		r = !0;
...
var mp = (e) => pp(e, !Q(e)), hp = (e) => pp(e, Q(e));
function gp(e, t) {
	return fp(e, t, (n) => e.moveByGroup(n, t));
}
var _p = (e) => gp(e, !Q(e)), vp = (e) => gp(e, Q(e)), yp = (e) => {
	let t = !Q(e);
...
var Tp = (e) => wp(e, !1), Ep = (e) => wp(e, !0), Dp = (e) => fp(e, !0, (t) => rp(e, t, !0)), Op = (e) => fp(e, !1, (t) => rp(e, t, !1)), kp = (e) => {
	...
	let t = Q(e);
	return fp(e, t, (n) => rp(e, n, t));
}, jp = (e) => fp(e, !1, (t) => O.cursor(e.lineBlockAt(t.head).from)), Mp = (e) => fp(e, !0, (t) => O.cursor(e.lineBlockAt(t.head).to)), Np = ({ state: e, dispatch: t }) => (t(Lf(e, { anchor: 0 })), !0), Pp = ({ state: e, dispatch: t }) => (t(Lf(e, { anchor: e.doc.length })), !0), Fp = ({ state: e, dispatch: t }) => (t(Lf(e, {
	anchor: e.selection.main.anchor,
	head: 0
})), !0), Ip = ({ state: e, dispatch: t }) => (t(Lf(e, {
	anchor: e.selection.main.anchor,
	head: e.doc.length
	...
	let n = rm(e).map(({ from: t, to: n }) => O.undirectionalRange(t, Math.min(n + 1, e.doc.length)));
	return t(e.update({
	...
	let n = If(e.selection, (t) => {
		...
		for (let e = r; e; e = e.next) {
			let { node: n } = e;
			if ((n.from < t.from && n.to >= t.to || n.to > t.to && n.from <= t.from) && e.next) return O.undirectionalRange(n.from, n.to);
		}
		return t;
	});
...
function Bp(e, t) {
	...
	return i.length != r.ranges.length && (e.dispatch(Lf(n, O.create(i, i.length - 1))), !0);
}
var Vp = (e) => Bp(e, !1), Hp = (e) => Bp(e, !0), Up = ({ state: e, dispatch: t }) => {
	let n = e.selection, r = null;
	return n.ranges.length > 1 ? r = O.create([n.main]) : n.main.empty || (r = O.create([O.cursor(n.main.head)])), r ? (t(Lf(e, r)), !0) : !1;
};
function Wp(e, t) {
...
var Kp = (e, t, n) => Wp(e, (r) => {
	...
	if (n && !t && i > o.from && i < o.from + 200 && !/[^ \t]/.test(s = o.text.slice(0, i - o.from))) {
		...
		let e = Zt(s, a.tabSize) % _u(a) || _u(a);
...
function mm(e) {
	return ({ state: t, dispatch: n }) => {
		...
		let r = t.changeByRange((n) => {
			...
			for (c == null && (c = Zt(/^\s*/.exec(t.doc.lineAt(r).text)[0], t.tabSize)); i < a.to && /\s/.test(a.text[i - a.from]);) i++;
			o ? {from: r, to: i} = o : r > a.from && r < a.from + 100 && !/\S/.test(a.text.slice(0, r)) && (r = a.from);
			let l = ["", vu(t, c)];
			return o && l.push(vu(t, s.lineIndent(a.from, -1))), {
				changes: {
					from: r,
					to: i,
					insert: C.of(l)
...
var gm = ({ state: e, dispatch: t }) => {
	...
	let n = Object.create(null), r = new bu(e, { overrideIndentation: (e) => {
		...
		if (o == null) return;
		/\S/.test(t.text) || (o = 0);
		let s = /^\s*/.exec(t.text)[0], c = vu(e, o);
	...
	if (!r) return;
	let i = Zt(r, e.tabSize), a = 0, o = vu(e, Math.max(0, i - _u(e)));
...
].concat(xm), Cm = typeof String.prototype.normalize == "function" ? (e) => e.normalize("NFKD") : (e) => e, wm = class {
	constructor(e, t, n = 0, r = e.length, i, a) {
		this.test = a, this.value = {
			from: 0,
			to: 0,
			precise: !1
		}, this.done = !1, this.matches = [], this.buffer = "", this.bufferPos = 0, this.iter = e.iterRange(n, r), this.bufferStart = n, this.normalize = i ? (e) => i(Cm(e)) : Cm, this.query = this.normalize(t);
	}
	peek() {
...
typeof Symbol < "u" && (wm.prototype[Symbol.iterator] = function() {
	return this;
});
var Tm = {
	from: -1,
	...
	match: /*@__PURE__*/ /.*/.exec(""),
	precise: !0
}, Em = "gm" + (/x/.unicode == null ? "" : "u"), Dm = class {
	constructor(e, t, n, r = 0, i = e.length) {
		if (this.text = e, this.to = i, this.curLine = "", this.done = !1, this.value = Tm, /\\[sWDnr]|\n|\r|\[\^/.test(t)) return new Am(e, t, n, r, i);
		this.re = new RegExp(t, Em + (n != null && n.ignoreCase ? "i" : "")), this.test = n == null ? void 0 : n.test, this.iter = e.iter();
		let a = e.lineAt(r);
		this.curLineStart = a.from, this.matchPos = Mm(e, r), this.getLine(this.curLineStart);
	}
	getLine(e) {
	...
	next() {
		for (let e = this.matchPos - this.curLineStart;;) {
			...
			if (t) {
				...
				if (this.matchPos = Mm(this.text, r + +(n == r)), n == this.curLineStart + this.curLine.length && this.nextLine(), (n < r || n > this.value.to) && (!this.test || this.test(n, r, t))) return this.value = {
					from: n,
					to: r,
					precise: !0,
					match: t
...
}, Om = /*@__PURE__*/ new WeakMap(), km = class e {
	constructor(e, t) {
	...
	static get(t, n, r) {
		...
		let { text: a, from: o } = i;
		return o > n && (a = t.sliceString(n, o) + a, o = n), i.to < r && (a += t.sliceString(i.to, r)), Om.set(t, new e(o, a)), new e(n, a.slice(n - o, r - o));
	}
}, Am = class {
	constructor(e, t, n, r, i) {
		this.text = e, this.to = i, this.done = !1, this.value = Tm, this.matchPos = Mm(e, r), this.re = new RegExp(t, Em + (n != null && n.ignoreCase ? "i" : "")), this.test = n == null ? void 0 : n.test, this.flat = km.get(e, r, this.chunkEnd(r + 5e3));
	}
	chunkEnd(e) {
		...
		for (;;) {
			...
			if (t && !t[0] && t.index == e && (this.re.lastIndex = e + 1, t = this.re.exec(this.flat.text)), t) {
				...
				if ((this.flat.to >= this.to || t.index + t[0].length <= this.flat.text.length - 10) && (!this.test || this.test(e, n, t))) return this.value = {
					...
					precise: !0,
					match: t
				}, this.matchPos = Mm(this.text, n + +(e == n)), this;
			}
			if (this.flat.to == this.to) return this.done = !0, this;
			this.flat = km.get(this.text, this.flat.from, this.chunkEnd(this.flat.from + this.flat.text.length * 2));
		}
	}
};
typeof Symbol < "u" && (Dm.prototype[Symbol.iterator] = Am.prototype[Symbol.iterator] = function() {
	return this;
});
function jm(e) {
	try {
		return new RegExp(e, Em), !0;
	} catch (e) {
		return !1;
	}
}
...
var Nm = (e) => {
	let t = Yc(e, "cm-goto-line");
	if (t) {
		let e = t.dom.querySelector("input[type=text]");
		return e && e.select(), !0;
	}
	let { state: n } = e, r = String(n.doc.lineAt(e.state.selection.main.head).number), { close: i, result: a } = Jc(e, {
		class: "cm-goto-line",
	...
	return a.then((t) => {
		...
		let f = n.doc.line(Math.max(1, Math.min(n.doc.lines, d))), p = O.cursor(f.from + Math.max(0, Math.min(u, f.length)));
		e.dispatch({
			effects: [i, J.scrollIntoView(p.from, { y: "center" })],
			selection: p
		});
	}), !0;
}, Pm = {
	...
	maxMatches: 100,
	wholeWords: !1
}, Fm = /*@__PURE__*/ k.define({ combine(e) {
	return Mt(e, Pm, {
...
function Im(e) {
	let t = [Hm, Vm];
	return e && t.push(Fm.of(e)), t;
}
var Lm = /*@__PURE__*/ B.mark({ class: "cm-selectionMatch" }), Rm = /*@__PURE__*/ B.mark({ class: "cm-selectionMatch cm-selectionMatch-main" });
function zm(e, t, n, r) {
...
var Vm = /*@__PURE__*/ W.fromClass(class {
	constructor(e) {
		this.decorations = this.getDeco(e);
	}
	update(e) {
	...
	getDeco(e) {
		let t = e.state.facet(Fm), { state: n } = e, r = n.selection;
		...
		if (i.empty) {
			...
			if (t.wholeWords) {
				if (a = n.sliceDoc(i.from, i.to), o = n.charCategorizer(i.head), !(zm(o, n, i.from, i.to) && Bm(o, n, i.from, i.to))) return B.none;
			} else if (a = n.sliceDoc(i.from, i.to), !a) return B.none;
		}
		let s = [];
		for (let r of e.visibleRanges) {
			let e = new wm(n.doc, a, r.from, r.to);
			for (; !e.next().done;) {
				let { from: r, to: a } = e.value;
				if ((!o || zm(o, n, r, a)) && (i.empty && r <= i.from && a >= i.to ? s.push(Rm.range(r, a)) : (r >= i.to || a <= i.from) && s.push(Lm.range(r, a)), s.length > t.maxMatches)) return B.none;
			}
		}
		return B.set(s);
	}
}, { decorations: (e) => e.decorations }), Hm = /*@__PURE__*/ J.baseTheme({
	".cm-selectionMatch": { backgroundColor: "#99ff7780" },
	".cm-searchMatch .cm-selectionMatch": { backgroundColor: "transparent" }
}), Um = ({ state: e, dispatch: t }) => {
...
function Wm(e, t) {
	...
	for (let n = !1, i = new wm(e.doc, t, r[r.length - 1].to);;) if (i.next(), i.done) {
		if (n) return null;
		i = new wm(e.doc, t, 0, Math.max(0, r[r.length - 1].from - 1)), n = !0;
	} else {
...
var Gm = ({ state: e, dispatch: t }) => {
	...
	if (n.some((e) => e.from === e.to)) return Um({
		state: e,
		dispatch: t
	});
...
}, Km = /*@__PURE__*/ k.define({ combine(e) {
	return Mt(e, {
		top: !1,
		caseSensitive: !1,
		literal: !1,
		regexp: !1,
		wholeWord: !1,
		createPanel: (e) => new Eh(e),
		scrollToMatch: (e) => J.scrollIntoView(e)
	});
} }), qm = class {
	constructor(e) {
		this.search = e.search, this.caseSensitive = !!e.caseSensitive, this.literal = !!e.literal, this.regexp = !!e.regexp, this.replace = e.replace || "", this.valid = !!this.search && (!this.regexp || jm(this.search)), this.unquoted = this.unquote(this.search), this.wholeWord = !!e.wholeWord, this.test = e.test;
	}
	unquote(e) {
	...
	create() {
		return this.regexp ? new ih(this) : new Qm(this);
	}
	getCursor(e, t = 0, n) {
		let r = e.doc ? e : N.create({ doc: e });
		return n == null && (n = r.doc.length), this.regexp ? eh(this, r, t, n) : Xm(this, r, t, n);
	}
}, Jm = class {
	constructor(e) {
		this.spec = e;
...
function Xm(e, t, n, r) {
	let i;
	return e.wholeWord && (i = Zm(t.doc, t.charCategorizer(t.selection.main.head))), e.test && (i = Ym(e.test, t, i)), new wm(t.doc, e.unquoted, n, r, e.caseSensitive ? void 0 : (e) => e.toLowerCase(), i);
}
function Zm(e, t) {
	return (n, r, i, a) => ((a > n || a + i.length < r) && (a = Math.max(0, n - 2), i = e.sliceString(a, Math.min(e.length, r + 2))), (t(th(i, n - a)) != M.Word || t(nh(i, n - a)) != M.Word) && (t(nh(i, r - a)) != M.Word || t(th(i, r - a)) != M.Word));
}
var Qm = class extends Jm {
	constructor(e) {
		super(e);
	}
	nextMatch(e, t, n) {
		let r = Xm(this.spec, e, n, e.doc.length).nextOverlapping();
		if (r.done) {
			let n = Math.min(e.doc.length, t + this.spec.unquoted.length);
			r = Xm(this.spec, e, 0, n).nextOverlapping();
		}
		return r.done || r.value.from == t && r.value.to == n ? null : r.value;
	}
	prevMatchInRange(e, t, n) {
		for (let r = n;;) {
			let n = Math.max(t, r - 1e4 - this.spec.unquoted.length), i = Xm(this.spec, e, n, r), a = null;
	...
	matchAll(e, t) {
		let n = Xm(this.spec, e, 0, e.doc.length), r = [];
		for (; !n.next().done;) {
	...
	highlight(e, t, n, r) {
		let i = Xm(this.spec, e, Math.max(0, t - this.spec.unquoted.length), Math.min(n + this.spec.unquoted.length, e.doc.length));
...
function eh(e, t, n, r) {
	let i;
	return e.wholeWord && (i = rh(t.charCategorizer(t.selection.main.head))), e.test && (i = $m(e.test, t, i)), new Dm(t.doc, e.search, {
...
function rh(e) {
	return (t, n, r) => !r[0].length || (e(th(r.input, r.index)) != M.Word || e(nh(r.input, r.index)) != M.Word) && (e(nh(r.input, r.index + r[0].length)) != M.Word || e(th(r.input, r.index + r[0].length)) != M.Word);
}
var ih = class extends Jm {
	nextMatch(e, t, n) {
		let r = eh(this.spec, e, n, e.doc.length).next();
		return r.done && (r = eh(this.spec, e, 0, t).next()), r.done ? null : r.value;
	}
	prevMatchInRange(e, t, n) {
		for (let r = 1;; r++) {
			let i = Math.max(t, n - r * 1e4), a = eh(this.spec, e, i, n), o = null;
	...
	matchAll(e, t) {
		let n = eh(this.spec, e, 0, e.doc.length), r = [];
		for (; !n.next().done;) {
			if (r.length >= t) return null;
			r.push(n.value);
		}
	...
	highlight(e, t, n, r) {
		let i = eh(this.spec, e, Math.max(0, t - 250), Math.min(n + 250, e.doc.length));
		for (; !i.next().done;) r(i.value.from, i.value.to);
	}
}, ah = /*@__PURE__*/ j.define(), oh = /*@__PURE__*/ j.define(), sh = /*@__PURE__*/ A.define({
	create(e) {
		return new ch(bh(e).create(), null);
	},
	update(e, t) {
		for (let n of t.effects) n.is(ah) ? e = new ch(n.value.create(), e.panel) : n.is(oh) && (e = new ch(e.query, n.value ? yh : null));
		return e;
	},
	provide: (e) => qc.from(e, (e) => e.panel)
}), ch = class {
	constructor(e, t) {
		this.query = e, this.panel = t;
	}
}, lh = /*@__PURE__*/ B.mark({ class: "cm-searchMatch" }), uh = /*@__PURE__*/ B.mark({ class: "cm-searchMatch cm-searchMatch-selected" }), dh = /*@__PURE__*/ W.fromClass(class {
	constructor(e) {
		this.view = e, this.decorations = this.highlight(e.state.field(sh));
	}
	update(e) {
		let t = e.state.field(sh);
		(t != e.startState.field(sh) || e.docChanged || e.selectionSet || e.viewportChanged) && (this.decorations = this.highlight(t));
	}
	highlight({ query: e, panel: t }) {
		if (!t || !e.spec.valid) return B.none;
		let { view: n } = this, r = new Bt();
...
function fh(e) {
	return (t) => {
		let n = t.state.field(sh, !1);
		return n && n.query.spec.valid ? e(t, n) : Ch(t);
	};
}
var ph = /*@__PURE__*/ fh((e, { query: t }) => {
	let { to: n } = e.state.selection.main, r = t.nextMatch(e.state, n, n);
	if (!r) return !1;
	let i = O.single(r.from, r.to), a = e.state.facet(Km);
	return e.dispatch({
		selection: i,
		effects: [Ah(e, r), a.scrollToMatch(i.main, e)],
		userEvent: "select.search"
	}), Sh(e), !0;
}), mh = /*@__PURE__*/ fh((e, { query: t }) => {
	let { state: n } = e, { from: r } = n.selection.main, i = t.prevMatch(n, r, r);
	if (!i) return !1;
	let a = O.single(i.from, i.to), o = e.state.facet(Km);
	return e.dispatch({
		selection: a,
		effects: [Ah(e, i), o.scrollToMatch(a.main, e)],
		userEvent: "select.search"
	}), Sh(e), !0;
}), hh = /*@__PURE__*/ fh((e, { query: t }) => {
	...
	for (let t = new wm(e.doc, e.sliceDoc(r, i)); !t.next().done;) {
	...
	return o && (c = O.single(o.from, o.to).map(d), u.push(Ah(e, o)), u.push(n.facet(Km).scrollToMatch(c.main, e))), e.dispatch({
		changes: d,
		selection: c,
		effects: u,
		userEvent: "input.replace"
	}), !0;
}), vh = /*@__PURE__*/ fh((e, { query: t }) => {
	if (e.state.readOnly) return !1;
	let n = [];
...
function yh(e) {
	return e.state.facet(Km).createPanel(e);
}
function bh(e, t) {
	var n, r, i, a, o;
...
var Ch = (e) => {
	let t = e.state.field(sh, !1);
	if (t && t.panel) {
		let n = xh(e);
		if (n && n != e.root.activeElement) {
			let r = bh(e.state, t.query.spec);
			r.valid && e.dispatch({ effects: ah.of(r) }), n.focus(), n.select();
		}
	} else e.dispatch({ effects: [oh.of(!0), t ? ah.of(bh(e.state, t.query.spec)) : j.appendConfig.of(Mh)] });
	return !0;
}, wh = (e) => {
	let t = e.state.field(sh, !1);
	if (!t || !t.panel) return !1;
	let n = Uc(e, yh);
	return n && n.dom.contains(e.root.activeElement) && e.focus(), e.dispatch({ effects: oh.of(!1) }), !0;
}, Th = [
	{
		key: "Mod-f",
		run: Ch,
	...
	constructor(e) {
		this.view = e;
		let t = this.query = e.state.field(sh).query.spec;
		this.commit = this.commit.bind(this), this.searchField = I("input", {
			value: t.search,
			placeholder: Dh(e, "Find"),
			"aria-label": Dh(e, "Find"),
			class: "cm-textfield",
			name: "search",
			form: "",
			"main-field": "true",
			...
			value: t.replace,
			placeholder: Dh(e, "Replace"),
			"aria-label": Dh(e, "Replace"),
			class: "cm-textfield",
			name: "replace",
			form: "",
			onchange: this.commit,
		...
		this.dom = I("div", {
			...
			this.searchField,
			n("next", () => ph(e), [Dh(e, "next")]),
			n("prev", () => mh(e), [Dh(e, "previous")]),
			n("select", () => hh(e), [Dh(e, "all")]),
			I("label", null, [this.caseField, Dh(e, "match case")]),
			I("label", null, [this.reField, Dh(e, "regexp")]),
			I("label", null, [this.wordField, Dh(e, "by word")]),
			...e.state.readOnly ? [] : [
				I("br"),
				this.replaceField,
				n("replace", () => _h(e), [Dh(e, "replace")]),
				n("replaceAll", () => vh(e), [Dh(e, "replace all")])
			],
			I("button", {
				name: "close",
				onclick: () => wh(e),
				"aria-label": Dh(e, "close"),
				type: "button"
			}, ["×"])
		]);
	}
	...
	keydown(e) {
		bs(this.view, e, "search-panel") ? e.preventDefault() : e.keyCode == 13 && e.target == this.searchField ? (e.preventDefault(), (e.shiftKey ? mh : ph)(this.view)) : e.keyCode == 13 && e.target == this.replaceField && (e.preventDefault(), _h(this.view));
	}
	update(e) {
		for (let t of e.transactions) for (let e of t.effects) e.is(ah) && !e.value.eq(this.query) && this.setQuery(e.value);
	}
	setQuery(e) {
	...
	get top() {
		return this.view.state.facet(Km).top;
	}
};
function Dh(e, t) {
...
var Oh = 30, kh = /[\s\.,:;?!]/;
function Ah(e, { from: t, to: n }) {
	let r = e.state.doc.lineAt(t), i = e.state.doc.lineAt(n).to, a = Math.max(r.from, t - Oh), o = Math.min(i, n + Oh), s = e.state.sliceDoc(a, o);
	if (a != r.from) {
		for (let e = 0; e < Oh; e++) if (!kh.test(s[e + 1]) && kh.test(s[e])) {
			s = s.slice(e);
			break;
		}
	}
	if (o != i) {
		for (let e = s.length - 1; e > s.length - Oh; e--) if (!kh.test(s[e - 1]) && kh.test(s[e])) {
			s = s.slice(0, e);
			break;
		}
	}
...
var jh = /*@__PURE__*/ J.baseTheme({
	...
	matchBefore(e) {
		let t = this.state.doc.lineAt(this.pos), n = Math.max(t.from, this.pos - 250), r = t.text.slice(n - t.from, this.pos - t.from), i = r.search(zh(e, !1));
		return i < 0 ? null : {
			from: n + i,
			to: this.pos,
			text: r.slice(i)
...
function Ih(e) {
	let t = e.map((e) => typeof e == "string" ? { label: e } : e), [n, r] = t.every((e) => /^\w+$/.test(e.label)) ? [/\w*$/, /\w+$/] : Fh(t);
	return (e) => {
...
var Bh = /*@__PURE__*/ gt.define();
function Vh(e, t, n, r) {
	let { main: i } = e.selection, a = n - i.from, o = r - i.from;
	return yn(yn({}, e.changeByRange((s) => {
...
function Uh(e) {
	...
	let t = Hh.get(e);
	return t || Hh.set(e, t = Ih(e)), t;
}
var Wh = /*@__PURE__*/ j.define(), Gh = /*@__PURE__*/ j.define(), Kh = class {
	constructor(e) {
		...
		for (let t = 0; t < e.length;) {
			...
			this.folded.push(T(a == i ? i.toLowerCase() : a, 0)), t += r;
		}
	...
	match(e) {
		...
		if (t.length == 1) {
			let r = T(e, 0), i = Fe(r), a = i == e.length ? 0 : -100;
			if (r != t[0]) {
				if (r == n[0]) a += -200;
				else return null;
			}
		...
		for (let r = 0, c = Math.min(e.length, 200), _ = 0; r < c && u < s;) {
			...
			let v, y = c < 255 ? c >= 48 && c <= 57 || c >= 97 && c <= 122 ? 2 : +(c >= 65 && c <= 90) : (v = Pe(c)) == v.toLowerCase() ? v == v.toUpperCase() ? 0 : 2 : 1;
			(!r || y == 1 && h || _ == 0 && y != 0) && (t[u] == c || n[u] == c && (d = !0) ? a[u++] = r : a.length && (g = !1)), _ = y, r += Fe(c);
		}
	...
	result(e, t, n) {
		let r = [], i = 0;
		for (let e of t) {
			let t = e + (this.astral ? Fe(T(n, e)) : 1);
	...
	return Mt(e, {
		...
		closeOnBlur: (e, t) => e && t,
		icons: (e, t) => e && t,
		tooltipClass: (e, t) => (n) => Jh(e(n), t(n)),
		optionClass: (e, t) => (n) => Jh(e(n), t(n)),
...
var $h = class {
	constructor(e, t, n) {
		...
		this.optionContent = Zh(o), this.optionClass = o.optionClass, this.tooltipClass = o.tooltipClass, this.range = Qh(i.length, a, o.maxRenderedOptions), this.dom = document.createElement("div"), this.dom.className = "cm-tooltip-autocomplete", this.updateTooltipClass(e.state), this.dom.addEventListener("mousedown", (n) => {
			...
			if (n.target == this.list) {
				...
				t != null && (e.dispatch({ effects: Xh.of(t) }), n.preventDefault());
			}
		}), this.dom.addEventListener("focusout", (t) => {
			let n = e.state.field(this.stateField, !1);
			n && n.tooltip && e.state.facet($).closeOnBlur && t.relatedTarget != e.contentDOM && e.dispatch({ effects: Gh.of(null) });
	...
	update(e) {
		...
		if (this.updateTooltipClass(e.state), n != r) {
			...
			(!r.open || r.open.options != i) && (this.range = Qh(i.length, a, e.state.facet($).maxRenderedOptions), this.showOptions(i, n.id)), this.updateSel(), o != ((t = r.open) == null ? void 0 : t.disabled) && this.dom.classList.toggle("cm-tooltip-autocomplete-disabled", !!o);
		}
	}
	...
	updateSel() {
		...
		(t.selected > -1 && t.selected < this.range.from || t.selected >= this.range.to) && (this.range = Qh(t.options.length, t.selected, this.view.state.facet($).maxRenderedOptions), this.showOptions(t.options, e.id));
...
function rg(e, t) {
	...
	for (let r of e) if (r.hasResult()) {
		...
		if (r.result.filter === !1) for (let t of r.result.options) a(new Lh(t, r.source, e ? e(t) : [], 1e9 - n.length));
		else {
			let n = t.sliceDoc(r.from, r.to), s, c = o.filterStrict ? new qh(n) : new Kh(n);
			for (let t of r.result.options) if (s = c.match(t.label)) {
				let n = t.displayLabel ? e ? e(t, s.matched) : [] : s.matched, o = s.score + (t.boost || 0);
				if (a(new Lh(t, r.source, n, o)), typeof t.section == "object" && t.section.rank === "dynamic") {
	...
	for (let e of n.sort((e, t) => t.score - e.score || l(e.completion, t.completion))) {
		let t = e.completion;
		!c || c.label != t.label || c.detail != t.detail || c.type != null && t.type != null && c.type != t.type || c.apply != t.apply || c.boost != t.boost ? s.push(e) : ng(e.completion) > ng(c) && (s[s.length - 1] = e), c = e.completion;
	}
	return s;
}
var ig = class e {
	...
	setSelected(t, n) {
		return t == this.selected || t >= this.options.length ? this : new e(this.options, lg(n, t), this.tooltip, this.timestamp, t, this.disabled);
	}
	...
	map(t) {
		return new e(this.options, this.attrs, yn(yn({}, this.tooltip), {}, { pos: t.mapPos(this.tooltip.pos) }), this.timestamp, this.selected, this.disabled);
	}
	setDisabled() {
	...
	static start() {
		return new e(ug, "cm-ac-" + Math.floor(Math.random() * 2e6).toString(36), null);
	}
	update(t) {
		let { state: n } = t, r = n.facet($), i = (r.override || n.languageDataAt("autocomplete", Rh(n)).map(Uh)).map((e) => (this.active.find((t) => t.source == e) || new fg(e, +!!this.active.some((e) => e.state != 0))).update(t, r));
		i.length == this.active.length && i.every((e, t) => e == this.active[t]) && (i = this.active);
		let a = this.open, o = t.effects.some((e) => e.is(hg));
		a && t.docChanged && (a = a.map(t.changes)), t.selection || i.some((e) => e.hasResult() && t.changes.touchesRange(e.from, e.to)) || !og(i, this.active) || o ? a = ig.build(i, n, this.id, a, r, o) : a && a.disabled && !i.some((e) => e.isPending) && (a = null), !a && i.every((e) => !e.isPending) && i.some((e) => e.hasResult()) && (i = i.map((e) => e.hasResult() ? new fg(e.source, 0) : e));
		for (let e of t.effects) e.is(Xh) && (a = a && a.setSelected(e.value, this.id));
	...
	get attrs() {
		return this.open ? this.open.attrs : this.active.length ? sg : cg;
	}
};
function og(e, t) {
	if (e == t) return !0;
...
var sg = { "aria-autocomplete": "list" }, cg = {};
function lg(e, t) {
	let n = {
...
var fg = class e {
	...
	update(t, n) {
		...
		for (let n of t.effects) if (n.is(Wh)) i = new e(i.source, 1, n.value);
		else if (n.is(Gh)) i = new e(i.source, 0);
		else if (n.is(hg)) for (let e of n.value) e.source == i.source && (i = e);
		return i;
	}
	updateFor(e, t) {
	...
	touches(e) {
		return e.changes.touchesRange(Rh(e.state));
	}
	...
	updateFor(t, n) {
		...
		let a = t.changes.mapPos(this.from), o = t.changes.mapPos(this.to, 1), s = Rh(t.state);
		if (s > o || !i || n & 2 && (Rh(t.startState) == this.from || s < this.limit)) return new fg(this.source, n & 4 ? 1 : 0);
		let c = t.changes.mapPos(this.limit);
		return mg(i.validFor, t.state, a, o) ? new e(this.source, this.explicit, c, i, a, o) : i.update && (i = i.update(i, a, o, new Nh(t.state, s, !1))) ? new e(this.source, this.explicit, c, i, i.from, (r = i.to) == null ? Rh(t.state) : r) : new fg(this.source, 1, this.explicit);
	}
	map(t) {
		if (t.empty) return this;
		let n = this.result.map ? this.result.map(this.result, t) : this.result;
		return n ? new e(this.source, this.explicit, t.mapPos(this.limit), n, t.mapPos(this.from), t.mapPos(this.to, 1)) : new fg(this.source, 0);
	}
	touches(e) {
...
function mg(e, t, n, r) {
	...
	return typeof e == "function" ? e(i, n, r, t) : zh(e, !0).test(i);
}
var hg = /*@__PURE__*/ j.define({ map(e, t) {
	return e.map((e) => e.map(t));
} }), gg = /*@__PURE__*/ A.define({
	create() {
		return ag.start();
	},
	update(e, t) {
	...
	provide: (e) => [kc.from(e, (e) => e.tooltip), J.contentAttributes.from(e, (e) => e.attrs)]
});
function _g(e, t) {
	let n = t.completion.apply || t.completion.label, r = e.state.field(gg).active.find((e) => e.source == t.source);
	return r instanceof pg && (typeof n == "string" ? e.dispatch(yn(yn({}, Vh(e.state, n, r.from, r.to)), {}, { annotations: Bh.of(t.completion) })) : n(e, t.completion, r.from, r.to), !0);
}
var vg = /*@__PURE__*/ eg(gg, _g);
function yg(e, t = "option") {
	return (n) => {
		let r = n.state.field(gg, !1);
		...
		return s < 0 ? s = t == "page" ? 0 : o - 1 : s >= o && (s = t == "page" ? o - 1 : 0), n.dispatch({ effects: Xh.of(s) }), !0;
	};
}
var bg = (e) => {
	let t = e.state.field(gg, !1);
	return e.state.readOnly || !t || !t.open || t.open.selected < 0 || t.open.disabled || Date.now() - t.open.timestamp < e.state.facet($).interactionDelay ? !1 : _g(e, t.open.options[t.open.selected]);
}, xg = (e) => e.state.field(gg, !1) ? (e.dispatch({ effects: Wh.of(!0) }), !0) : !1, Sg = (e) => {
	let t = e.state.field(gg, !1);
	return !t || !t.active.some((e) => e.state != 0) ? !1 : (e.dispatch({ effects: Gh.of(null) }), !0);
}, Cg = class {
	constructor(e, t) {
		this.active = e, this.context = t, this.time = Date.now(), this.updates = [], this.done = void 0;
	}
}, wg = 50, Tg = 1e3, Eg = /*@__PURE__*/ W.fromClass(class {
	constructor(e) {
		this.view = e, this.debounceUpdate = -1, this.running = [], this.debounceAccept = -1, this.pendingStart = !1, this.composing = 0;
		for (let t of e.state.field(gg).active) t.isPending && this.startQuery(t);
	}
	update(e) {
		let t = e.state.field(gg), n = e.state.facet($);
		if (!e.selectionSet && !e.docChanged && e.startState.field(gg) == t) return;
		...
		for (let t = 0; t < this.running.length; t++) {
			...
			if (r || n.context.abortOnDocChange && e.docChanged || n.updates.length + e.transactions.length > wg && Date.now() - n.time > Tg) {
		...
		this.debounceUpdate > -1 && clearTimeout(this.debounceUpdate), e.transactions.some((e) => e.effects.some((e) => e.is(Wh))) && (this.pendingStart = !0);
	...
	startUpdate() {
		...
		let { state: e } = this.view, t = e.field(gg);
	...
	startQuery(e) {
		let { state: t } = this.view, n = new Nh(t, Rh(t), e.explicit, this.view), r = new Cg(e, n);
		this.running.push(r), Promise.resolve(e.source(n)).then((e) => {
			r.context.aborted || (r.done = e || null, this.scheduleAccept());
		}, (e) => {
			this.view.dispatch({ effects: Gh.of(null) }), U(this.view.state, e);
		});
	}
	scheduleAccept() {
	...
	accept() {
		...
		let t = [], n = this.view.state.facet($), r = this.view.state.field(gg);
		for (let i = 0; i < this.running.length; i++) {
			let a = this.running[i];
			if (a.done === void 0) continue;
			if (this.running.splice(i--, 1), a.done) {
				let r = Rh(a.updates.length ? a.updates[0].startState : this.view.state), i = Math.min(r, a.done.from + +!a.active.explicit), o = new pg(a.active.source, a.active.explicit, i, a.done, a.done.from, (e = a.done.to) == null ? r : e);
			...
			if (o && o.isPending) {
				if (a.done == null) {
					let e = new fg(a.active.source, 0);
					for (let t of a.updates) e = e.update(t, n);
					e.isPending || t.push(e);
				} else this.startQuery(o);
			}
		}
		(t.length || r.open && r.open.disabled) && this.view.dispatch({ effects: hg.of(t) });
	}
}, { eventHandlers: {
	blur(e) {
		let t = this.view.state.field(gg, !1);
		if (t && t.tooltip && this.view.state.facet($).closeOnBlur) {
			let n = t.open && Bc(this.view, t.open.tooltip);
			(!n || !n.dom.contains(e.relatedTarget)) && setTimeout(() => this.view.dispatch({ effects: Gh.of(null) }), 10);
		}
	},
	compositionstart() {
		this.composing = 1;
	...
	compositionend() {
		this.composing == 3 && setTimeout(() => this.view.dispatch({ effects: Wh.of(!1) }), 20), this.composing = 0;
	}
} }), Dg = typeof navigator == "object" && /*@__PURE__*/ /Win/.test(navigator.platform), Og = /*@__PURE__*/ tt.highest(/*@__PURE__*/ J.domEventHandlers({ keydown(e, t) {
	let n = t.state.field(gg, !1);
	if (!n || !n.open || n.open.disabled || n.open.selected < 0 || e.key.length > 1 || e.ctrlKey && !(Dg && e.altKey) || e.metaKey) return !1;
	...
	return a && a.indexOf(e.key) > -1 && _g(t, r), !1;
} })), kg = /*@__PURE__*/ J.baseTheme({
	...
	before: ")]}:;>",
	stringPrefixes: []
}, jg = /*@__PURE__*/ j.define({ map(e, t) {
	let n = t.mapPos(e, -1, E.TrackAfter);
	return n == null ? void 0 : n;
} }), Mg = /*@__PURE__*/ new class extends Nt {}();
Mg.startSide = 1, Mg.endSide = -1;
var Ng = /*@__PURE__*/ A.define({
	create() {
		return P.empty;
	},
	update(e, t) {
		...
		for (let n of t.effects) n.is(jg) && (e = e.update({ add: [Mg.range(n.value, n.value + 1)] }));
		return e;
	}
});
function Pg() {
...
var Fg = "()[]{}<>«»»«［］｛｝";
function Ig(e) {
	for (let t = 0; t < 16; t += 2) if (Fg.charCodeAt(t) == e) return Fg.charAt(t + 1);
	return Pe(e < 128 ? e : e + 1);
}
function Lg(e, t) {
	return e.languageDataAt("closeBrackets", t)[0] || Ag;
}
var Rg = typeof navigator == "object" && /*@__PURE__*/ /Android\b/.test(navigator.userAgent), zg = /*@__PURE__*/ J.inputHandler.of((e, t, n, r) => {
	if ((Rg ? e.composing : e.compositionStarted) || e.state.readOnly) return !1;
	let i = e.state.selection.main;
	if (r.length > 2 || r.length == 2 && Fe(T(r, 0)) == 1 || t != i.from || n != i.to) return !1;
	let a = Vg(e.state, r);
	...
	run: ({ state: e, dispatch: t }) => {
		if (e.readOnly) return !1;
		let n = Lg(e, e.selection.main.head).brackets || Ag.brackets, r = null, i = e.changeByRange((t) => {
			if (t.empty) {
				let r = Wg(e.doc, t.head);
				for (let i of n) if (i == r && Ug(e.doc, t.head) == Ig(T(i, 0))) return {
					changes: {
...
function Vg(e, t) {
	let n = Lg(e, e.selection.main.head), r = n.brackets || Ag.brackets;
	for (let i of r) {
		let a = Ig(T(i, 0));
		if (t == i) return a == i ? qg(e, i, r.indexOf(i + i + i) > -1, n) : Gg(e, i, a, n.before || Ag.before);
		if (t == a && Hg(e, e.selection.main.from)) return Kg(e, i, a);
	}
	return null;
}
function Hg(e, t) {
	let n = !1;
	return e.field(Ng).between(0, e.doc.length, (e) => {
		e == t && (n = !0);
	}), n;
}
function Ug(e, t) {
	let n = e.sliceString(t, t + 2);
	return n.slice(0, Fe(T(n, 0)));
}
function Wg(e, t) {
	let n = e.sliceString(t - 2, t);
	return Fe(T(n, 0)) == n.length ? n : n.slice(1);
}
function Gg(e, t, n, r) {
...
function Kg(e, t, n) {
	let r = null, i = e.changeByRange((t) => t.empty && Ug(e.doc, t.head) == n ? {
		changes: {
			from: t.head,
			to: t.head + n.length,
			insert: n
...
function qg(e, t, n, r) {
	let i = r.stringPrefixes || Ag.stringPrefixes, a = null, o = e.changeByRange((r) => {
		if (!r.empty) return {
			changes: [{
				insert: t,
				from: r.from
			...
			effects: jg.of(r.to + t.length),
			range: O.range(r.anchor + t.length, r.head + t.length)
		};
		let o = r.head, s = Ug(e.doc, o), c;
		if (s == t) {
			if (Jg(e, o)) return {
				changes: {
					insert: t + t,
		...
		} else if (n && e.sliceDoc(o - 2 * t.length, o) == t + t && (c = Xg(e, o - 2 * t.length, i)) > -1 && Jg(e, c)) return {
			changes: {
				insert: t + t + t + t,
				from: o
			},
		...
		else if (e.charCategorizer(o)(s) != M.Word && Xg(e, o, i) > -1 && !Yg(e, o, t, i)) return {
			changes: {
				insert: t + t,
				from: o
			},
...
var Qg = [
	...
	{
		key: "PageDown",
		run: /*@__PURE__*/ yg(!0, "page")
	},
	{
		key: "PageUp",
		run: /*@__PURE__*/ yg(!1, "page")
	},
	{
		key: "Enter",
		run: bg
	}
], $g = /*@__PURE__*/ tt.highest(/*@__PURE__*/ _s.computeN([$], (e) => e.facet($).defaultKeymap ? [Qg] : [])), e_ = class {
	constructor(e, t, n) {
	...
	static init(t, n, r) {
		let i = r.facet(h_).markerFilter;
		i && (t = i(t, r));
		let a = t.slice().sort((e, t) => e.from - t.from || e.to - t.to), o = new Bt(), s = [], c = 0, l = r.doc.iter(), u = 0, d = r.doc.length;
		for (let e = 0;;) {
		...
		let f = o.finish();
		return new e(f, n, n_(f));
	}
};
function n_(e, t = null, n = 0) {
	let r = null;
	return e.between(n, 1e9, (e, n, { spec: i }) => {
		if (!(t && i.diagnostics.indexOf(t) < 0)) {
			if (!r) r = new e_(e, n, t || i.diagnostics[0]);
			else if (i.diagnostics.indexOf(r.diagnostic) < 0) return !1;
			else r = new e_(r.from, n, r.diagnostic);
		}
	}), r;
}
function r_(e, t) {
	let n = t.pos, r = t.end || n, i = e.state.facet(h_).hideOn(e, n, r);
	if (i != null) return i;
	let a = e.startState.doc.lineAt(t.pos);
	return !!(e.effects.some((e) => e.is(a_)) || e.changes.touchesRange(a.from, Math.max(a.to, r)));
}
function i_(e, t) {
	return e.field(c_, !1) ? t : t.concat(j.appendConfig.of(O_));
}
var a_ = /*@__PURE__*/ j.define(), o_ = /*@__PURE__*/ j.define(), s_ = /*@__PURE__*/ j.define(), c_ = /*@__PURE__*/ A.define({
	create() {
		return new t_(B.none, null, null);
	},
	update(e, t) {
		if (t.docChanged && e.diagnostics.size) {
			...
			if (e.selected) {
				...
				r = n_(n, e.selected.diagnostic, i) || n_(n, null, i);
			}
			!n.size && i && t.state.facet(h_).autoPanel && (i = null), e = new t_(n, i, r);
		}
		for (let n of t.effects) if (n.is(a_)) {
			let r = t.state.facet(h_).autoPanel ? n.value.length ? x_.open : null : e.panel;
			e = t_.init(n.value, r, t.state);
		} else n.is(o_) ? e = new t_(e.diagnostics, n.value ? x_.open : null, e.selected) : n.is(s_) && (e = new t_(e.diagnostics, e.panel, n.value));
		return e;
	},
	provide: (e) => [qc.from(e, (e) => e.panel), J.decorations.from(e, (e) => e.diagnostics)]
}), l_ = /*@__PURE__*/ B.mark({ class: "cm-lintRange cm-lintRange-active" });
function u_(e, t, n) {
	let { diagnostics: r } = e.state.field(c_), i, a = -1, o = -1;
	r.between(t - +(n < 0), t + +(n > 0), (e, r, { spec: s }) => {
		if (t >= e && t <= r && (e == r || (t > e || n > 0) && (t < r || n < 0))) return i = s.diagnostics, a = e, o = r, !1;
	});
	let s = e.state.facet(h_).tooltipFilter;
...
function d_(e, t) {
	return I("ul", { class: "cm-tooltip-lint" }, t.map((t) => v_(e, t, !1)));
}
var f_ = (e) => {
	let t = e.state.field(c_, !1);
	(!t || !t.panel) && e.dispatch({ effects: i_(e.state, [o_.of(!0)]) });
	let n = Uc(e, x_.open);
	return n && n.dom.querySelector(".cm-panel-lint ul").focus(), !0;
}, p_ = (e) => {
	let t = e.state.field(c_, !1);
	return !t || !t.panel ? !1 : (e.dispatch({ effects: o_.of(!1) }), !0);
}, m_ = [{
	key: "Mod-Shift-m",
	run: f_,
	preventDefault: !0
	...
	run: (e) => {
		let t = e.state.field(c_, !1);
		if (!t) return !1;
		let n = e.state.selection.main, r = n_(t.diagnostics, null, n.to + 1);
		return !r && (r = n_(t.diagnostics, null, 0), !r || r.from == n.from && r.to == n.to) ? !1 : (e.dispatch({
			selection: {
				anchor: r.from,
				head: r.to
			},
...
}], h_ = /*@__PURE__*/ k.define({ combine(e) {
	return yn({ sources: e.map((e) => e.source).filter((e) => e != null) }, Mt(e.map((e) => e.config), {
		delay: 750,
		markerFilter: null,
		tooltipFilter: null,
		needsRefresh: null,
...
function v_(e, t, n) {
	...
	return I("li", { class: "cm-diagnostic cm-diagnostic-" + t.severity }, I("span", { class: "cm-diagnosticText" }, t.renderMessage ? t.renderMessage(e) : t.message), (r = t.actions) == null ? void 0 : r.map((n, r) => {
		let a = !1, o = (r) => {
			...
			a = !0;
			let i = n_(e.state.field(c_).diagnostics, t);
...
var y_ = class extends In {
	...
	constructor(e, t) {
		this.diagnostic = t, this.id = "item_" + Math.floor(Math.random() * 4294967295).toString(16), this.dom = v_(e, t, !0), this.dom.id = this.id, this.dom.setAttribute("role", "option");
	}
}, x_ = class e {
	constructor(e) {
		...
		let t = (t) => {
			if (!(t.ctrlKey || t.altKey || t.metaKey)) {
				if (t.keyCode == 27) p_(this.view), this.view.focus();
					...
					let { diagnostic: n } = this.items[this.selectedIndex], r = __(n.actions);
					for (let i = 0; i < r.length; i++) if (r[i].toUpperCase().charCodeAt(0) == t.keyCode) {
						let t = n_(this.view.state.field(c_).diagnostics, n);
		...
		this.list = I("ul", {
			...
			onclick: () => p_(this.view)
		}, "×")), this.update();
	}
	get selectedIndex() {
		let e = this.view.state.field(c_).selected;
		if (!e) return -1;
		for (let t = 0; t < this.items.length; t++) if (this.items[t].diagnostic == e.diagnostic) return t;
		return -1;
	}
	update() {
		let { diagnostics: e, selected: t } = this.view.state.field(c_), n = 0, r = !1, i = null, a = /* @__PURE__ */ new Set();
		for (e.between(0, this.view.state.doc.length, (e, o, { spec: s }) => {
			for (let e of s.diagnostics) {
				...
				o < 0 ? (s = new b_(this.view, e), this.items.splice(n, 0, s), r = !0) : (s = this.items[o], o > n && (this.items.splice(n, o - n), r = !0)), t && s.diagnostic == t.diagnostic ? s.dom.hasAttribute("aria-selected") || (s.dom.setAttribute("aria-selected", "true"), i = s) : s.dom.hasAttribute("aria-selected") && s.dom.removeAttribute("aria-selected"), n++;
			}
		}); n < this.items.length && !(this.items.length == 1 && this.items[0].diagnostic.from < 0);) r = !0, this.items.pop();
		this.items.length == 0 && (this.items.push(new b_(this.view, {
			from: -1,
			to: -1,
			severity: "info",
	...
	moveSelection(e) {
		...
		let t = n_(this.view.state.field(c_).diagnostics, this.items[e].diagnostic);
...
function S_(e, t = "viewBox=\"0 0 40 40\"") {
	return `url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" ${t}>${encodeURIComponent(e)}</svg>')`;
}
function C_(e) {
	return S_(`<path d="m0 2.5 l2 -1.5 l1 0 l2 1.5 l1 0" stroke="${e}" fill="none" stroke-width=".7"/>`, "width=\"6\" height=\"3\"");
}
var w_ = /*@__PURE__*/ J.baseTheme({
	".cm-diagnostic": {
	...
	".cm-lintRange-error": { backgroundImage: /*@__PURE__*/ C_("#f11") },
	".cm-lintRange-warning": { backgroundImage: /*@__PURE__*/ C_("orange") },
	".cm-lintRange-info": { backgroundImage: /*@__PURE__*/ C_("#999") },
	".cm-lintRange-hint": { backgroundImage: /*@__PURE__*/ C_("#66d") },
...
var D_ = /*@__PURE__*/ Rc(u_, { hideOn: r_ }), O_ = [
	c_,
	/*@__PURE__*/ J.decorations.compute([c_], (e) => {
		let { selected: t, panel: n } = e.field(c_);
		return !t || !n || t.from == t.to ? B.none : B.set([l_.range(t.from, t.to)]);
	}),
	D_,
	w_
], k_ = [
